...
define("ui/utility/FontsListener", ["require", "exports", "utility/State"], function (require, exports, State_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    State_2 = __importDefault(State_2);
    var FontsListener;
    (function (FontsListener) {
        FontsListener.loaded = (0, State_2.default)(false);
...
define("utility/Style", ["require", "exports", "utility/State", "utility/Task"], function (require, exports, State_3, Task_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/utility/StyleManipulator", ["require", "exports", "style", "utility/DevServer", "utility/Env", "utility/Script", "utility/State", "utility/Style"], function (require, exports, style_1, DevServer_1, Env_3, Script_1, State_4, Style_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Style_1 = __importDefault(Style_1);
    const style = (0, State_4.default)(style_1.default);
...
define("ui/utility/FocusListener", ["require", "exports", "utility/State"], function (require, exports, State_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    State_5 = __importDefault(State_5);
    var FocusListener;
    (function (FocusListener) {
        FocusListener.hasFocus = (0, State_5.default)(false);
        FocusListener.focused = (0, State_5.default)(undefined);
        FocusListener.focusedLast = (0, State_5.default)(undefined);
...
define("ui/utility/Mouse", ["require", "exports", "utility/State"], function (require, exports, State_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Mouse) {
        const pos = { x: 0, y: 0 };
        Mouse.state = (0, State_6.default)(pos);
...
define("ui/utility/TypeManipulator", ["require", "exports", "utility/State"], function (require, exports, State_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    State_7 = __importDefault(State_7);
    const TypeManipulator = Object.assign(function (host, onAdd, onRemove) {
        const state = (0, State_7.default)(new Set());
...
define("ui/utility/Viewport", ["require", "exports", "utility/State", "utility/Style"], function (require, exports, State_8, Style_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var Viewport;
    (function (Viewport) {
        Viewport.size = State_8.default.JIT(() => ({ w: window.innerWidth, h: window.innerHeight }));
        Viewport.mobile = State_8.default.JIT(() => {
            const result = State_8.default.UseManual({
                contentWidth: Style_2.default.measure('--content-width'),
                viewport: Viewport.size,
            }).mapManual(({ contentWidth, viewport }) => viewport.w < contentWidth);
            result.subscribeManual(Viewport.mobile.markDirty);
            return result;
        });
        Viewport.tablet = State_8.default.JIT(() => {
            const result = State_8.default.UseManual({
                tabletWidth: Style_2.default.measure('--tablet-width'),
                viewport: Viewport.size,
            }).mapManual(({ tabletWidth, viewport }) => viewport.w < tabletWidth);
            result.subscribeManual(Viewport.tablet.markDirty);
            return result;
        });
        function listen() {
...
define("ui/component/core/Popover", ["require", "exports", "ui/Component", "ui/InputBus", "ui/utility/FocusListener", "ui/utility/HoverListener", "ui/utility/Mouse", "ui/utility/TypeManipulator", "ui/utility/Viewport", "utility/Objects", "utility/State", "utility/Task"], function (require, exports, Component_3, InputBus_1, FocusListener_1, HoverListener_1, Mouse_2, TypeManipulator_1, Viewport_1, Objects_2, State_9, Task_2) {
    ...
    const Popover = Component_3.default.Builder((component) => {
        let mousePadding;
        let unbind;
        const visible = (0, State_9.default)(false);
        ...
        const popover = component
            ...
            popoverChildren: (0, State_9.default)([]),
            popoverParent: (0, State_9.default)(undefined),
...
define("ui/component/core/Slot", ["require", "exports", "ui/Component", "ui/component/core/ext/ComponentInsertionTransaction", "utility/AbortPromise", "utility/State"], function (require, exports, Component_4, ComponentInsertionTransaction_1, AbortPromise_1, State_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Slot = Object.assign(Component_4.default.Builder((slot) => {
        ...
        const elses = (0, State_10.default)({ elseIfs: [] });
        let unuseElses;
        return slot
            .extend(slot => ({
            use: (state, initialiser) => {
                state = State_10.default.get(state);
                unuse?.();
                unuse = undefined;
                abort?.();
                abort = undefined;
                ...
                state.use(slot, value => {
                    ...
                    if (!value) {
                        ...
                        const unuseElsesContainer = elses.useManual(elses => {
                            unuseElsesList = State_10.default.MapManual(elses.elseIfs.map(({ state }) => state), (...elses) => elses.indexOf(true))
                                .useManual(elseToUse => {
        ...
        using: (value, initialiser) => Slot().use(State_10.default.get(value), initialiser),
    });
    exports.default = Slot;
});
define("ui/component/core/ext/CanHasActionsMenu", ["require", "exports", "ui/Component", "ui/component/core/Button", "ui/component/core/Popover", "ui/component/core/Slot", "utility/Objects"], function (require, exports, Component_5, Button_1, Popover_1, Slot_1, Objects_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const CanHasActionsMenu = Component_5.default.Extension((component, popoverInitialiser) => {
        ...
        return component
            ...
            setActionsMenu(initialiser) {
                ...
                component.clearPopover().setPopover('hover', (popover, button) => (0, Objects_3.mutable)(component).actionsMenu = popover
                    .and(ActionsMenu)
                    .type('flush')
...
define("ui/component/core/Heading", ["require", "exports", "ui/Component", "ui/utility/MarkdownContent", "ui/utility/TextManipulator", "utility/Define", "utility/maths/Maths", "utility/State"], function (require, exports, Component_7, MarkdownContent_1, TextManipulator_1, Define_3, Maths_1, State_11) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Heading = Component_7.default.Builder('h1', (component) => {
        ...
        let aestheticLevel;
        let aestheticStyle;
        const resizeRange = (0, State_11.default)(undefined);
        State_11.default.Map(component, [component.text.state, resizeRange], (...args) => args)
...
define("ui/component/core/Link", ["require", "exports", "ui/Component", "utility/Env", "utility/State"], function (require, exports, Component_8, Env_4, State_12) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Link = Component_8.default.Builder('a', (component, route) => {
        ...
        const canNavigate = (0, State_12.default)(true);
...
define("ui/component/core/Block", ["require", "exports", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/ext/CanHasActionsMenu", "ui/component/core/Heading", "ui/component/core/Link", "ui/component/core/Paragraph", "ui/utility/TypeManipulator", "utility/State"], function (require, exports, Component_10, ActionRow_1, CanHasActionsMenu_1, Heading_1, Link_1, Paragraph_1, TypeManipulator_2, State_13) {
    ...
    const Block = Component_10.default.Builder((component) => {
        ...
        const block = component
            ...
            .tweak(block => block
            .style.bindFrom(State_13.default.MapManual([isLink, block.type.state], (link, types) => [...types].map((t) => `block${link ? '--link' : ''}--type-${t}`))))
            ...
            .appendTo(block));
        return block
            .and(CanHasActionsMenu_1.default, popover => popover
            .anchor.reset()
...
define("ui/component/core/Dialog", ["require", "exports", "ui/Component", "utility/State"], function (require, exports, Component_11, State_14) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_11 = __importDefault(Component_11);
    State_14 = __importDefault(State_14);
    const Dialog = Component_11.default.Builder(() => {
        const opened = (0, State_14.default)(false);
        const willOpen = (0, State_14.default)(false);
        const willClose = (0, State_14.default)(false);
        let modal = true;
        let unbind;
...
define("ui/component/core/Checkbutton", ["require", "exports", "ui/Component", "ui/component/core/Button", "utility/State"], function (require, exports, Component_13, Button_2, State_15) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_13 = __importDefault(Component_13);
    Button_2 = __importDefault(Button_2);
    State_15 = __importDefault(State_15);
    const Checkbutton = Component_13.default.Builder('label', (component) => {
        const input = (0, Component_13.default)('input')
            .style('checkbutton-input')
            .attributes.set('type', 'checkbox');
        const inputElement = input.element;
        const state = (0, State_15.default)(false);
        let unuse;
...
define("ui/component/OAuthService", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/Checkbutton", "utility/State"], function (require, exports, Session_1, Component_14, Checkbutton_1, State_16) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const OAuthService = Component_14.default.Builder((component, service, reauthDangerToken) => {
        ...
        const isAuthed = State_16.default.Truthy(component, authorisationState);
        const button = component
            ...
            .append((0, Component_14.default)('img')
            .style('oauth-service-icon')
            .attributes.set('src', service.icon))
            .append((0, Component_14.default)()
        ...
        if (!reauthDangerToken)
            (0, Component_14.default)()
                .style('oauth-service-state')
                .style.bind(isAuthed, 'oauth-service-state--authenticated')
                .style.bind(State_16.default.Map(button, [button.hoveredOrFocused, button.disabled], (focus, disabled) => focus && !disabled), 'oauth-service-state--focus')
                .appendTo((0, Component_14.default)()
                .style('oauth-service-state-wrapper')
                .style.bind(button.hoveredOrFocused, 'oauth-service-state-wrapper--focus')
                .appendTo(button));
        const username = (0, Component_14.default)()
...
define("ui/component/OAuthServices", ["require", "exports", "endpoint/auth/EndpointAuthServices", "model/Session", "ui/Component", "ui/component/core/Block", "ui/component/OAuthService", "utility/Objects", "utility/State"], function (require, exports, EndpointAuthServices_1, Session_2, Component_15, Block_2, OAuthService_1, Objects_4, State_17) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const OAuthServices = Component_15.default.Builder(async (component, state, reauthDangerToken) => {
        const block = component
            .and(Block_2.default)
        ...
        const list = (0, Component_15.default)()
...
define("ui/component/core/ConfirmDialog", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/BlockDialog", "ui/component/core/Button", "ui/component/core/Paragraph", "ui/component/OAuthServices", "ui/utility/StringApplicator", "utility/State"], function (require, exports, Session_3, Component_16, BlockDialog_1, Button_3, Paragraph_2, OAuthServices_1, StringApplicator_1, State_18) {
    ...
    const ConfirmDialog = Object.assign(Component_16.default.Builder(async (component, definition) => {
...
define("ui/component/core/Form", ["require", "exports", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/Block", "ui/component/core/Button", "utility/State"], function (require, exports, Component_17, ActionRow_2, Block_3, Button_4, State_19) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Form = Component_17.default.Builder((component, label) => {
        const form = (component.replaceElement('form')
            .style('form')
            .ariaRole('form')
            .ariaLabelledBy(label));
        form.receiveDescendantInsertEvents();
        const valid = State_19.default.Generator(() => (form.element).checkValidity());
        form.event.subscribe(['input', 'change', 'descendantInsert'], () => valid.refresh());
        const content = (form.is(Block_3.default) ? form.content : (0, Component_17.default)())
            .style('form-content');
        ...
        return form
            ...
            .appendTo(submitButtonWrapper ??= (0, Component_17.default)()
            ...
            .style.bind(State_19.default.Every(form, submitButtonWrapper.hovered, submitButton.disabled), 'button--disabled--hover')
            .style.bind(State_19.default.Every(form, submitButtonWrapper.active, submitButton.disabled), 'button--disabled--active')));
    });
...
define("ui/component/core/LabelledRow", ["require", "exports", "ui/Component", "ui/component/core/Label"], function (require, exports, Component_18, Label_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_18 = __importDefault(Component_18);
    const LabelledRow = Component_18.default.Builder((row) => {
        row.style('labelled-row');
        let label = (0, Label_1.AutoLabel)().style('labelled-row-label').appendTo(row);
        let content = (0, Component_18.default)().style('labelled-row-content').appendTo(row);
        return row
            .extend(row => ({
            label, content,
        }))
            ...
            set: newLabel => {
                if (label === newLabel)
                    return;
                Component_18.default.removeContents(label.element);
            ...
            set: newContent => {
                if (content === newContent)
                    return;
                Component_18.default.removeContents(content.element);
...
define("ui/component/core/LabelledTable", ["require", "exports", "ui/Component", "ui/component/core/LabelledRow"], function (require, exports, Component_19, LabelledRow_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_19 = __importDefault(Component_19);
    LabelledRow_1 = __importDefault(LabelledRow_1);
    const LabelledTable = Component_19.default.Builder((table) => {
...
define("ui/component/core/ProgressWheel", ["require", "exports", "lang/en-nz", "ui/Component", "ui/component/core/Slot", "utility/State"], function (require, exports, en_nz_1, Component_20, Slot_2, State_20) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const ProgressWheelBuilder = Component_20.default.Builder((component) => {
        return component
            .style('progress-wheel')
            .extend(wheel => ({
            set(definition) {
                wheel.removeContents();
                (0, Component_20.default)()
                    .style('progress-wheel-icon')
                    .tweak(definition.initialiseIcon)
                    .appendTo(wheel);
                const label = (0, Component_20.default)()
    ...
    const ProgressWheel = Object.assign(ProgressWheelBuilder, {
        Length(length, maxLength) {
            const unusedPercent = State_20.default.MapManual([length, maxLength], (length, maxLength) => length === undefined || !maxLength ? undefined : 1 - length / maxLength);
            const unusedChars = State_20.default.MapManual([length, maxLength], (length, maxLength) => length === undefined || !maxLength ? undefined : maxLength - length);
            return Slot_2.default.using(State_20.default.UseManual({ unusedPercent, unusedChars }), (slot, { unusedPercent, unusedChars }) => unusedPercent === undefined || unusedChars === undefined ? undefined
...
define("ui/utility/AnchorManipulator", ["require", "exports", "ui/utility/Mouse", "ui/utility/Viewport", "utility/State", "utility/Time"], function (require, exports, Mouse_3, Viewport_2, State_21, Time_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function AnchorManipulator(host) {
        ...
        let refCache;
        const location = (0, State_21.default)(undefined);
        ...
        const result = {
            ...
            get: () => {
                ...
                if (anchoredBox && locationPreference && from) {
                    for (const preference of locationPreference) {
                        ...
                        const xCenter = (xBox?.left ?? 0) + (xBox?.width ?? Viewport_2.default.size.value.w) / 2;
                        ...
                        if (!xConf.sticky && anchoredBox.width < Viewport_2.default.size.value.w && !preference.options?.allowXOffscreen) {
                            const isXOffScreen = x < 0 || x + anchoredBox.width > Viewport_2.default.size.value.w;
                            if (isXOffScreen) {
                                continue;
                            }
                        }
                        ...
                        const yCenter = (yBox?.top ?? 0) + (yBox?.height ?? Viewport_2.default.size.value.h) / 2;
                        ...
                        if (!yConf.sticky && anchoredBox.height < Viewport_2.default.size.value.h && !preference.options?.allowYOffscreen) {
                            const isYOffScreen = y < 0
                                || y + anchoredBox.height > Viewport_2.default.size.value.h;
                            if (isYOffScreen) {
                                continue;
                            }
                        }
            ...
            apply: () => {
                ...
                if (location.mouse) {
                    const shouldFlip = currentAlignment === 'centre' || (currentAlignment === 'right' ? location.x < Viewport_2.default.size.value.w / 2 - 200 : location.x > Viewport_2.default.size.value.w / 2 + 200);
                    if (shouldFlip) {
...
define("ui/component/core/ext/Input", ["require", "exports", "ui/Component", "ui/component/core/Block", "ui/component/core/Popover", "ui/component/core/ProgressWheel", "ui/component/core/Slot", "ui/utility/AnchorManipulator", "ui/utility/StringApplicator", "ui/utility/Viewport", "utility/State"], function (require, exports, Component_21, Block_4, Popover_2, ProgressWheel_1, Slot_3, AnchorManipulator_1, StringApplicator_2, Viewport_3, State_22) {
    ...
    function createHintText(hint) {
        return (0, Component_21.default)()
            .style('input-popover-hint-text')
            .text.bind(hint);
    }
    const Input = Object.assign(Component_21.default.Extension((component) => {
        const hintText = (0, State_22.default)(undefined);
        const maxLength = (0, State_22.default)(undefined);
        const length = (0, State_22.default)(undefined);
        const invalid = (0, State_22.default)('');
        const popoverOverride = (0, State_22.default)(false);
        const hasPopover = State_22.default.MapManual([hintText, maxLength, popoverOverride], (hintText, maxLength, override) => override || !!hintText || !!maxLength);
        let popover;
        hasPopover.subscribeManual(hasPopover => {
            ...
            popover = (0, Popover_2.default)()
                ...
                if (popoverOverride.value)
                    return;
                Slot_3.default.using(hintText, (slot, hintText) => !hintText ? undefined : createHintText(hintText))
                    .appendTo(popover);
                ...
                .appendTo(document.body);
            Viewport_3.default.tablet.use(popover, isTablet => {
                const tablet = isTablet();
        ...
        component.hasFocused.subscribeManual(hasFocused => {
            if (customPopoverVisibilityHandling)
                return;
            if (Viewport_3.default.tablet.value)
                return;
            popover?.toggle(hasFocused).anchor.apply();
        });
        const customInvalidMessage = (0, State_22.default)(undefined);
        ...
        const input = component.extend(component => ({
            required: (0, State_22.default)(false),
...
define("ui/component/core/TextInput", ["require", "exports", "lang/en-nz", "ui/Component", "ui/component/core/ext/Input", "ui/utility/StringApplicator", "utility/State"], function (require, exports, en_nz_2, Component_22, Input_1, StringApplicator_3, State_23) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const TextInput = Component_22.default.Builder('input', (component) => {
        let shouldIgnoreInputEvent = false;
        let filterFunction;
        const state = (0, State_23.default)('');
...
define("ui/component/core/TextInputBlock", ["require", "exports", "ui/Component", "ui/component/core/TextInput"], function (require, exports, Component_23, TextInput_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_23 = __importDefault(Component_23);
    TextInput_1 = __importDefault(TextInput_1);
    const TextInputBlock = Component_23.default.Builder((component) => {
        const inputs = [];
        const block = component
            ...
            addInput: (initialiser) => {
                const input = (0, TextInput_1.default)()
                    ...
                    .appendTo((0, Component_23.default)()
...
define("ui/component/core/LabelledTextInputBlock", ["require", "exports", "ui/Component", "ui/component/core/Label", "ui/component/core/TextInputBlock"], function (require, exports, Component_24, Label_2, TextInputBlock_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_24 = __importDefault(Component_24);
    TextInputBlock_1 = __importDefault(TextInputBlock_1);
    const LabelledTextInputBlock = Component_24.default.Builder((block) => {
        block.style('labelled-text-input-block', 'labelled-row')
            .ariaRole('group');
        const labels = (0, Component_24.default)()
...
define("ui/Announcer", ["require", "exports", "ui/Component"], function (require, exports, Component_25) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Announcer) {
        ...
        function getAssertive() {
            return assertive ??= (0, Component_25.default)()
        ...
        let polite;
        function getPolite() {
            return polite ??= (0, Component_25.default)()
        ...
        function announceInternal(within, id, announcer) {
            ...
            announcer(keyOrHandler => {
                components.push((0, Component_25.default)('p')
...
define("ui/component/core/RadioButton", ["require", "exports", "ui/Component", "ui/component/core/Checkbutton"], function (require, exports, Component_26, Checkbutton_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_26 = __importDefault(Component_26);
    Checkbutton_2 = __importDefault(Checkbutton_2);
    const RadioButton = Component_26.default.Builder(() => {
...
define("ui/view/shared/ext/ViewTransition", ["require", "exports", "ui/Component", "utility/Arrays"], function (require, exports, Component_27, Arrays_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (ViewTransition) {
        ...
        const PADDING = 100;
        Component_27.default.extend(component => component.extend(component => ({
            viewTransition(name) {
                if (name) {
...
define("utility/Store", ["require", "exports", "utility/State"], function (require, exports, State_24) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class Store {
        ...
        static get state() {
            ...
            return statesProxy ??= new Proxy({}, {
                ...
                get(_, key) {
                    return s[key] ??= (0, State_24.default)(Store.get(key));
                },
            });
        }
        static get full() {
...
define("ui/component/core/TextEditor", ["require", "exports", "lang/en-nz", "model/Session", "prosemirror-commands", "prosemirror-dropcursor", "prosemirror-example-setup", "prosemirror-gapcursor", "prosemirror-history", "prosemirror-inputrules", "prosemirror-keymap", "prosemirror-markdown", "prosemirror-model", "prosemirror-schema-list", "prosemirror-state", "prosemirror-transform", "prosemirror-view", "ui/Announcer", "ui/Component", "ui/component/core/Button", "ui/component/core/Checkbutton", "ui/component/core/Dialog", "ui/component/core/ext/Input", "ui/component/core/Popover", "ui/component/core/RadioButton", "ui/component/core/Slot", "ui/utility/StringApplicator", "ui/utility/Viewport", "ui/view/shared/ext/ViewTransition", "utility/Arrays", "utility/Define", "utility/Env", "utility/Objects", "utility/State", "utility/Store", "utility/string/Markdown", "utility/Time", "w3c-keyname"], function (require, exports, en_nz_3, Session_4, prosemirror_commands_1, prosemirror_dropcursor_1, prosemirror_example_setup_1, prosemirror_gapcursor_1, prosemirror_history_1, prosemirror_inputrules_1, prosemirror_keymap_1, prosemirror_markdown_1, prosemirror_model_1, prosemirror_schema_list_1, prosemirror_state_1, prosemirror_transform_1, prosemirror_view_1, Announcer_1, Component_28, Button_5, Checkbutton_3, Dialog_2, Input_2, Popover_3, RadioButton_1, Slot_4, StringApplicator_4, Viewport_4, ViewTransition_1, Arrays_4, Define_4, Env_5, Objects_5, State_25, Store_1, Markdown_2, Time_4, w3c_keyname_1) {
    ...
    const schema = new prosemirror_model_1.Schema({
        nodes: Objects_5.default.filterNullish({
            ...
            heading: {
                ...
                content: 'text*',
                toDOM(node) {
                    const heading = (0, Component_28.default)(`h${node.attrs.level}`);
    ...
    let globalid = 0;
    const TextEditor = Component_28.default.Builder((component) => {
        const id = globalid++;
        const isMarkdown = (0, State_25.default)(false);
        const content = (0, State_25.default)('');
        const isFullscreen = (0, State_25.default)(false);
        const minimal = (0, State_25.default)(false);
        const isMinimal = State_25.default.MapManual([minimal, content], (minimal, content) => minimal && !content.trim());
        // eslint-disable-next-line prefer-const
        let editor;
        const state = (0, State_25.default)(undefined);
        ////////////////////////////////////
        ...
        ////////////////////////////////////
        //#region Types
        const ToolbarButtonTypeMark = Component_28.default.Extension((component, type) => {
            const mark = schema.marks[type];
            return component
                .ariaLabel.use(`component/text-editor/toolbar/button/${type}`)
                .extend(() => ({ mark }));
        });
        const ToolbarButtonTypeNode = Component_28.default.Extension((component, type) => {
            const node = schema.nodes[type.replaceAll('-', '_')];
            return component
                .ariaLabel.use(`component/text-editor/toolbar/button/${type}`)
                .extend(() => ({ node }));
        });
        const ToolbarButtonTypeOther = Component_28.default.Extension((component, type) => {
            return component
                .ariaLabel.use(`component/text-editor/toolbar/button/${type}`);
        });
        //#endregion
        ...
        ////////////////////////////////////
        //#region Components
        const ToolbarButtonGroup = Component_28.default.Builder(component => component
            .ariaRole('group')
            .style('text-editor-toolbar-button-group'));
        const ToolbarButton = Component_28.default.Builder((_, handler) => {
        ...
        const ToolbarCheckbutton = Component_28.default.Builder((_, state, toggler) => {
        ...
        const ToolbarRadioButton = Component_28.default.Builder((_, name, state, toggler) => {
        ...
        const ToolbarButtonPopover = Component_28.default.Builder((_, align) => {
            return (0, Button_5.default)()
        ...
        ////////////////////////////////////
        //#region Specifics
        const ToolbarButtonMark = Component_28.default.Builder((_, type) => {
            const mark = schema.marks[type];
        ...
        const ToolbarButtonAlign = Component_28.default.Builder((_, align) => {
        ...
        const ToolbarButtonBlockType = Component_28.default.Builder((_, type) => {
            const node = schema.nodes[type.replaceAll('-', '_')];
        ...
        const ToolbarButtonHeading = Component_28.default.Builder((_, level) => {
        ...
        const ToolbarButtonWrap = Component_28.default.Builder((_, type) => ToolbarButton(wrapper(schema.nodes[type.replaceAll('-', '_')]))
            .and(ToolbarButtonTypeNode, type));
        const ToolbarButtonList = Component_28.default.Builder((_, type) => ToolbarButton(listWrapper(schema.nodes[type.replaceAll('-', '_')]))
            .and(ToolbarButtonTypeNode, type));
        //#endregion
        ...
        types();
        ////////////////////////////////////
        const toolbar = (0, Component_28.default)()
        ...
        const hiddenInput = (0, Component_28.default)('input')
        ...
        const actualEditor = (0, Component_28.default)()
            .subviewTransition(viewTransitionName)
            .style('text-editor')
            .style.bind(isFullscreen, 'text-editor--fullscreen')
            .event.subscribe('click', event => {
            const target = Component_28.default.get(event.target);
        ...
        const documentSlot = (0, Slot_4.default)();
        documentSlot
            ...
            return createDefaultView((0, Slot_4.default)().appendTo(slot));
        })
            .appendTo(actualEditor);
        const contentWidth = State_25.default.Generator(() => `${editor.document?.element.scrollWidth ?? 0}px`)
            .observe(component, state, Viewport_4.default.size);
        const scrollbarProxy = (0, Component_28.default)()
            ...
            .appendTo(actualEditor);
        const fullscreenContentWidth = State_25.default.Generator(() => `${documentSlot.element.scrollWidth ?? 0}px`)
            .observe(component, state, Viewport_4.default.size);
        ...
        function createDefaultView(slot) {
            ...
            editor.mirror = view;
            editor.document = (0, Component_28.default)()
                .and(Input_2.default)
...
define("ui/component/core/toast/ToastList", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/toast/Toast", "utility/Async", "utility/Task", "utility/Time"], function (require, exports, Session_5, Component_29, Toast_1, Async_2, Task_4, Time_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const ToastComponent = Component_29.default.Builder((component) => {
        const title = (0, Component_29.default)()
            .style('toast-title')
            .appendTo(component);
        return component
            .style('toast')
            ...
            .extendJIT('content', toast => (0, Component_29.default)()
            .style('toast-content')
            .appendTo(toast));
    }).setName('Toast');
    const ToastList = Component_29.default.Builder((component) => {
        ...
        async function lifecycle(toast, component) {
            const wrapper = (0, Component_29.default)().style('toast-wrapper').appendTo(toasts);
...
define("ui/component/core/toast/Toast", ["require", "exports", "ui/Component"], function (require, exports, Component_30) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/component/VanityInput", ["require", "exports", "ui/Component", "ui/component/core/ext/Input", "ui/component/core/TextInput"], function (require, exports, Component_31, Input_3, TextInput_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const VanityInput = Component_31.default.Builder((component) => {
...
define("ui/view/account/AccountViewForm", ["require", "exports", "endpoint/author/EndpointAuthorCreate", "endpoint/author/EndpointAuthorUpdate", "lang/en-nz", "model/FormInputLengths", "model/Session", "ui/Component", "ui/component/core/Block", "ui/component/core/Form", "ui/component/core/LabelledTable", "ui/component/core/LabelledTextInputBlock", "ui/component/core/TextEditor", "ui/component/core/TextInput", "ui/component/core/toast/Toast", "ui/component/VanityInput"], function (require, exports, EndpointAuthorCreate_1, EndpointAuthorUpdate_1, en_nz_4, FormInputLengths_1, Session_6, Component_32, Block_5, Form_1, LabelledTable_1, LabelledTextInputBlock_1, TextEditor_1, TextInput_3, Toast_2, VanityInput_1) {
    ...
    exports.default = Component_32.default.Builder((component, type) => {
...
define("ui/component/core/Breadcrumbs", ["require", "exports", "ui/Component", "ui/component/core/Button", "ui/component/core/Heading", "ui/component/core/Link"], function (require, exports, Component_33, Button_6, Heading_2, Link_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Breadcrumbs = Component_33.default.Builder((component) => {
        const pathComponent = (0, Component_33.default)()
        ...
        const breadcrumbs = component.style('breadcrumbs')
            ...
            .extendJIT('meta', breadcrumbs => (0, Component_33.default)()
            .viewTransition('breadcrumbs-meta')
            .prependTo(breadcrumbs))
            .extendJIT('info', breadcrumbs => (0, Component_33.default)()
            ...
            .extendJIT('description', breadcrumbs => (0, Component_33.default)()
            .style('breadcrumbs-description')
            .appendTo(breadcrumbs.info))
            .extendJIT('actions', breadcrumbs => (0, Component_33.default)()
...
define("ui/view/shared/component/View", ["require", "exports", "ui/Component", "ui/component/core/Breadcrumbs"], function (require, exports, Component_34, Breadcrumbs_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_34 = __importDefault(Component_34);
    Breadcrumbs_1 = __importDefault(Breadcrumbs_1);
    const View = Component_34.default.Builder((_, id) => {
        const content = (0, Component_34.default)().style('view-content');
        return (0, Component_34.default)()
...
define("ui/view/AccountView", ["require", "exports", "endpoint/author/EndpointAuthorDelete", "model/Session", "ui/component/core/ActionRow", "ui/component/core/Button", "ui/component/core/ConfirmDialog", "ui/component/core/Slot", "ui/component/OAuthServices", "ui/view/account/AccountViewForm", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "ui/view/shared/ext/ViewTransition", "utility/State"], function (require, exports, EndpointAuthorDelete_1, Session_7, ActionRow_3, Button_7, ConfirmDialog_1, Slot_5, OAuthServices_2, AccountViewForm_1, View_1, ViewDefinition_1, ViewTransition_2, State_26) {
    ...
    exports.default = (0, ViewDefinition_1.default)({
        create: async () => {
            ...
            const state = (0, State_26.default)(Session_7.default.Auth.state.value);
...
define("ui/component/core/ExternalLink", ["require", "exports", "ui/Component"], function (require, exports, Component_35) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_35 = __importDefault(Component_35);
    const ExternalLink = Component_35.default.Builder('a', (component, href) => {
...
define("ui/component/Author", ["require", "exports", "lang/en-nz", "model/Follows", "model/Session", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/ExternalLink", "ui/component/core/Placeholder", "ui/component/core/Slot"], function (require, exports, en_nz_5, Follows_1, Session_8, Component_37, Block_6, Button_8, ExternalLink_1, Placeholder_1, Slot_6) {
    ...
    exports.default = Component_37.default.Builder((component, author) => {
        ...
        block.description
            ...
            .append(author.pronouns && (0, Slot_6.default)()
            .text.append(' · ')
            .append((0, Component_37.default)()
        ...
        if (author.description)
            (0, Component_37.default)()
                ...
                .append((0, Slot_6.default)().tweak(slot => {
                const body = author.description.body;
                if (body)
                    slot.setMarkdownContent(author.description);
                else
                    slot.and(Placeholder_1.default).text.use('author/description/empty');
            }))
...
define("ui/component/core/Paginator", ["require", "exports", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Slot", "utility/Async", "utility/State"], function (require, exports, Component_38, Block_7, Button_9, Slot_7, Async_3, State_27) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Paginator = Component_38.default.Builder((component) => {
        ...
        const buttonLast = (0, Button_9.default)()
        ...
        let pageContent = [];
        let pages = [];
        const cursor = (0, State_27.default)(0);
        ...
        const paginator = block
            ...
            page: cursor,
            data,
            useInitial(initialData, page_, pageCount_) {
...
define("ui/component/core/Timestamp", ["require", "exports", "ui/Component", "utility/State", "utility/Time"], function (require, exports, Component_40, State_28, Time_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Timestamp = Component_40.default.Builder((component, time) => {
        let translation;
        const state = (0, State_28.default)(new Date(time ?? Date.now()));
...
define("ui/component/core/ext/Draggable", ["require", "exports", "ui/Component", "utility/maths/Vector2", "utility/State"], function (require, exports, Component_41, Vector2_1, State_29) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const isDraggingAnyDraggable = (0, State_29.default)(false);
    const Draggable = Object.assign(Component_41.default.Extension((component, definition = {}) => {
        component.style('draggable');
        const state = (0, State_29.default)(DragState.None);
        const overrideStickyDistance = (0, State_29.default)(undefined);
        const overrideDelay = (0, State_29.default)(undefined);
        const stickyDistance = State_29.default.MapManual([overrideStickyDistance, definition.stickyDistance], (override, base) => override ?? base ?? 0);
        const delay = State_29.default.MapManual([overrideDelay, definition.delay], (override, base) => override ?? base ?? 0);
...
define("ui/component/core/ext/Sortable", ["require", "exports", "ui/Component", "ui/component/core/ext/Draggable", "utility/Arrays", "utility/maths/Vector2", "utility/State"], function (require, exports, Component_43, Draggable_2, Arrays_5, Vector2_2, State_30) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const isSortingAnySortable = (0, State_30.default)(false);
    exports.default = Object.assign(Component_43.default.Extension((component, definition) => {
        const sorting = (0, State_30.default)(false);
        const sortDelay = (0, State_30.default)(definition.sortDelay ?? 0);
        const stickyDistance = (0, State_30.default)(definition.stickyDistance ?? 0);
        const order = (0, State_30.default)([]);
...
define("ui/utility/Applicator", ["require", "exports", "utility/State"], function (require, exports, State_31) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function Applicator(host, defaultValueOrApply, apply) {
        ...
        function makeApplicator(host) {
            return {
                state: (0, State_31.default)(defaultValue),
                set: value => {
                    unbind?.();
                    setInternal(value);
                    return host;
...
define("ui/component/TagsEditor", ["require", "exports", "lang/en-nz", "model/Tags", "ui/Component", "ui/component/core/Block", "ui/component/core/ext/Input", "ui/component/core/ext/Sortable", "ui/component/core/ProgressWheel", "ui/component/core/Slot", "ui/component/core/TextInput", "ui/component/Tag", "ui/utility/AnchorManipulator", "ui/utility/Applicator", "utility/AbortPromise", "utility/Mouse", "utility/State", "utility/string/Strings"], function (require, exports, en_nz_6, Tags_1, Component_44, Block_8, Input_4, Sortable_1, ProgressWheel_2, Slot_8, TextInput_4, Tag_1, AnchorManipulator_2, Applicator_1, AbortPromise_2, Mouse_4, State_32, Strings_2) {
    ...
    const TagsEditor = Component_44.default.Builder((component) => {
        const tagsState = (0, State_32.default)({ global_tags: [], custom_tags: [] });
        ////////////////////////////////////
        //#region Current
        const tagsContainer = (0, Slot_8.default)()
        ...
        ////////////////////////////////////
        //#region Suggestions
        const hasOrHadFocus = State_32.default.Some(component, component.hasFocused, component.hadFocusedLast);
        const suggestions = (0, Slot_8.default)()
            .style('tags-editor-suggestions')
            .use(State_32.default.UseManual({
            tags: tagsState,
            filter: input.state,
            focus: hasOrHadFocus,
        ...
        const maxLengthGlobal = (0, State_32.default)(undefined);
        const maxLengthCustom = (0, State_32.default)(undefined);
...
define("ui/component/Tags", ["require", "exports", "model/Tags", "ui/Component", "ui/component/core/Slot", "ui/component/Tag", "utility/AbortPromise", "utility/State"], function (require, exports, Tags_2, Component_45, Slot_9, Tag_2, AbortPromise_3, State_33) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Tags = Component_45.default.Builder((component) => {
        const state = (0, State_33.default)(undefined);
        let definition;
        (0, Slot_9.default)()
        ...
        (0, Slot_10.default)()
            ...
            if (!isFlush)
                (0, Component_46.default)()
                    ...
                    .append((0, Slot_10.default)().tweak(slot => {
...
define("ui/view/AuthorView", ["require", "exports", "endpoint/author/EndpointAuthorGet", "endpoint/work/EndpointWorkGetAllAuthor", "model/Session", "ui/Component", "ui/component/Author", "ui/component/core/Button", "ui/component/core/Link", "ui/component/core/Paginator", "ui/component/core/Slot", "ui/component/Work", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition"], function (require, exports, EndpointAuthorGet_1, EndpointWorkGetAllAuthor_1, Session_10, Component_47, Author_1, Button_12, Link_5, Paginator_1, Slot_11, Work_1, View_2, ViewDefinition_2) {
    ...
    exports.default = (0, ViewDefinition_2.default)({
        create: async (params) => {
            ...
            await paginator.useEndpoint(worksQuery, (slot, works) => slot.append(...works.map(workData => (0, Link_5.default)(`/work/${author.data.vanity}/${workData.vanity}`)
                .and(Work_1.default, workData, author.data)
                .viewTransition(false)
                .type('flush')
                .appendTo(slot))));
            paginator.orElse(slot => (0, Component_47.default)()
                .style('placeholder')
...
define("ui/component/core/InfoDialog", ["require", "exports", "ui/Component", "ui/component/core/BlockDialog", "ui/component/core/Button", "ui/utility/StringApplicator", "utility/State"], function (require, exports, Component_48, BlockDialog_2, Button_13, StringApplicator_5, State_34) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const InfoDialog = Object.assign(Component_48.default.Builder((component, definition) => {
        ...
        const state = (0, State_34.default)(undefined);
...
define("endpoint/chapter/EndpointChapterCreate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_24) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_24 = __importDefault(Endpoint_24);
    exports.default = (0, Endpoint_24.default)('/work/{author}/{vanity}/chapter/create', 'post');
});
define("endpoint/chapter/EndpointChapterUpdate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_25) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_25 = __importDefault(Endpoint_25);
    exports.default = (0, Endpoint_25.default)('/work/{author}/{work}/chapter/{url}/update', 'post');
});
define("endpoint/work/EndpointWorkGet", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_26) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_26 = __importDefault(Endpoint_26);
    exports.default = (0, Endpoint_26.default)('/work/{author}/{vanity}/get', 'get');
});
define("ui/component/core/RadioRow", ["require", "exports", "ui/Component", "ui/component/core/ext/Input", "ui/component/core/RadioButton", "ui/utility/Applicator", "utility/State"], function (require, exports, Component_49, Input_5, RadioButton_2, Applicator_2, State_35) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const RadioRow = Component_49.default.Builder((component) => {
        const selection = (0, State_35.default)(undefined);
        const options = {};
...
define("ui/view/ChapterEditView", ["require", "exports", "endpoint/chapter/EndpointChapterDelete", "endpoint/chapter/EndpointChapterGet", "model/Chapters", "ui/component/core/ActionRow", "ui/component/core/Button", "ui/component/core/InfoDialog", "ui/component/core/Slot", "ui/view/chapter/ChapterEditForm", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "ui/view/shared/ext/ViewTransition", "utility/State"], function (require, exports, EndpointChapterDelete_2, EndpointChapterGet_1, Chapters_1, ActionRow_4, Button_14, InfoDialog_1, Slot_12, ChapterEditForm_1, View_3, ViewDefinition_3, ViewTransition_3, State_36) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = (0, ViewDefinition_3.default)({
        ...
        create: async (params) => {
            ...
            const view = (0, View_3.default)(id);
            const chapter = !params.url ? undefined : await EndpointChapterGet_1.default.query({ params: params });
            if (chapter instanceof Error)
                throw chapter;
            if (!chapter?.data)
                await InfoDialog_1.default.prompt(view, {
                    titleTranslation: 'shared/prompt/beta-restrictions/title',
                    bodyTranslation: 'shared/prompt/beta-restrictions/description',
                });
            if (params && chapter)
                view.breadcrumbs.setBackButton(`/work/${params.author}/${params.work}/chapter/${params.url}`, button => button.subText.set(chapter.data.name));
            const state = (0, State_36.default)(chapter?.data);
            const stateInternal = (0, State_36.default)(chapter?.data);
            (0, Slot_12.default)()
                .use(state, () => (0, ChapterEditForm_1.default)(stateInternal, Chapters_1.default.work(params)).subviewTransition(id))
                .appendTo(view.content);
            (0, Slot_12.default)()
                .use(state, () => createActionRow()?.subviewTransition(id))
                .appendTo(view.content);
            ...
            function createActionRow() {
                ...
                return (0, ActionRow_4.default)()
                    ...
                    .tweak(row => row.right
                    .append((0, Button_14.default)()
                    .text.use('view/chapter-edit/update/action/delete')
                    .event.subscribe('click', async () => {
                    if (!params.url)
                        return;
                    const response = await EndpointChapterDelete_2.default.query({ params: { ...params, url: params.url } });
                    if (toast.handleError(response))
                        return;
...
define("endpoint/chapter/EndpointChapterGetPaged", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_27) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_27 = __importDefault(Endpoint_27);
    exports.default = (0, Endpoint_27.default)('/work/{author}/{work}/chapters/paged', 'get');
});
...
define("ui/component/Chapter", ["require", "exports", "model/Chapters", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/ext/CanHasActionsMenu", "ui/component/core/Link", "ui/component/core/Timestamp", "utility/maths/Maths"], function (require, exports, Chapters_2, Session_12, Component_51, Button_15, CanHasActionsMenu_2, Link_6, Timestamp_2, Maths_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function initActions(actions, chapter, work, author) {
        return actions
            ...
            && (0, Button_15.default)()
                ...
                .event.subscribe('click', () => Chapters_2.default.delete(chapter)));
    }
    const Chapter = Object.assign(Component_51.default.Builder((component, chapter, work, author) => {
        ...
        if (chapter.visibility === 'Private')
            timestamp = (0, Component_51.default)()
...
define("ui/component/Reaction", ["require", "exports", "ui/Component", "ui/component/core/Button", "utility/State"], function (require, exports, Component_52, Button_16, State_37) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Reaction = Component_52.default.Builder((component, type, reactionsIn = (0, State_37.default)(0), reactedIn = (0, State_37.default)(false)) => {
        const reactions = State_37.default.get(reactionsIn);
        const reacted = State_37.default.get(reactedIn);
        return component
            .style('reaction')
...
define("ui/component/Comment", ["require", "exports", "endpoint/comment/EndpointCommentAdd", "endpoint/comment/EndpointCommentDelete", "endpoint/comment/EndpointCommentUpdate", "endpoint/reaction/EndpointReactComment", "endpoint/reaction/EndpointUnreactComment", "lang/en-nz", "model/FormInputLengths", "model/Session", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/Button", "ui/component/core/Link", "ui/component/core/Slot", "ui/component/core/TextEditor", "ui/component/core/Timestamp", "ui/component/Reaction"], function (require, exports, EndpointCommentAdd_1, EndpointCommentDelete_1, EndpointCommentUpdate_1, EndpointReactComment_1, EndpointUnreactComment_1, en_nz_9, FormInputLengths_4, Session_13, Component_53, ActionRow_5, Button_17, Link_7, Slot_13, TextEditor_3, Timestamp_3, Reaction_1) {
    ...
    const Comment = Component_53.default.Builder((component, source, commentData, meta) => {
        ...
        comment.use(comments, (slot, commentsData) => {
            ...
            if (commentData && !meta?.isRootComment) {
                ...
                (0, Link_7.default)(!author?.vanity ? undefined : `/author/${author.vanity}`)
                ...
                if (commentData.edit) {
                    ...
                    const footer = (0, Component_53.default)('footer').and(ActionRow_5.default)
                    ...
                    (0, Slot_13.default)()
                        ...
                        if (!author)
                            return;
                        const footer = (0, Component_53.default)('footer')
            ...
            const childrenWrapper = (0, Component_53.default)()
...
define("ui/component/Comments", ["require", "exports", "endpoint/comment/EndpointCommentGetAllUnder", "model/Session", "ui/Component", "ui/component/Comment", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Slot", "utility/AbortPromise", "utility/State"], function (require, exports, EndpointCommentGetAllUnder_1, Session_14, Component_54, Comment_1, Block_11, Button_18, Slot_14, AbortPromise_4, State_38) {
    ...
    const Comments = Component_54.default.Builder((rawComponent, under, isRootComment) => {
        ...
        (0, Slot_14.default)()
            ...
            const comments = (0, State_38.default)([comment]);
            const authors = (0, State_38.default)(!author ? [] : [author]);
            if (author)
            ...
            const query = (0, State_38.default)(undefined);
...
define("ui/view/shared/component/PaginatedView", ["require", "exports", "ui/Component", "ui/component/core/Paginator", "ui/view/shared/component/View"], function (require, exports, Component_55, Paginator_2, View_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_55 = __importDefault(Component_55);
    Paginator_2 = __importDefault(Paginator_2);
    View_4 = __importDefault(View_4);
    const PaginatedView = Component_55.default.Builder((_, id) => {
        let paginator;
        const urls = [];
        return (0, View_4.default)(id)
            .extend(view => ({
            setURL,
            paginator: () => {
...
define("ui/view/ChapterView", ["require", "exports", "endpoint/chapter/EndpointChapterGet", "endpoint/chapter/EndpointChapterGetPaged", "endpoint/history/EndpointHistoryAddChapter", "endpoint/reaction/EndpointReactChapter", "endpoint/reaction/EndpointUnreactChapter", "endpoint/work/EndpointWorkGet", "lang/en-nz", "model/Chapters", "model/TextBody", "ui/Component", "ui/component/Chapter", "ui/component/Comments", "ui/component/core/Button", "ui/component/core/Link", "ui/component/core/Slot", "ui/component/Reaction", "ui/component/Tags", "ui/component/Work", "ui/view/shared/component/PaginatedView", "ui/view/shared/component/ViewDefinition", "utility/maths/Maths", "utility/State"], function (require, exports, EndpointChapterGet_2, EndpointChapterGetPaged_1, EndpointHistoryAddChapter_1, EndpointReactChapter_1, EndpointUnreactChapter_1, EndpointWorkGet_1, en_nz_10, Chapters_3, TextBody_1, Component_56, Chapter_1, Comments_1, Button_19, Link_8, Slot_15, Reaction_2, Tags_4, Work_2, PaginatedView_1, ViewDefinition_4, Maths_3, State_39) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = (0, ViewDefinition_4.default)({
        create: async (params) => {
            ...
            const response = await EndpointWorkGet_1.default.query({ params: Chapters_3.default.work(params) });
            if (response instanceof Error)
                throw response;
            ...
            (0, Link_8.default)(`/work/${author?.vanity}/${workData.vanity}`)
            ...
            const chapterState = (0, State_39.default)(initialChapterResponse.data);
            ...
            const paginator = await view.paginator()
                ...
                if (chapter.notes_before || chapter.global_tags?.length || chapter.custom_tags?.length)
                    (0, Component_56.default)()
                        ...
                        .prepend(chapter.notes_before && (0, Component_56.default)()
                        .style('view-type-chapter-block-notes-label')
                        .text.use('chapter/notes/label'))
                        .append((chapter.global_tags?.length || chapter.custom_tags?.length) && (0, Component_56.default)()
                ...
                if (chapter.notes_after)
                    (0, Component_56.default)()
                        ...
                        .prepend(chapter.notes_after && (0, Component_56.default)()
                        .style('view-type-chapter-block-notes-label')
                        .text.use('chapter/notes/label'))
                        .appendTo(slot);
            });
            ...
            paginator.setActionsMenu(popover => Chapter_1.default.initActions(popover, chapterState.value, workData, author));
            (0, Link_8.default)(`/work/${params.author}/${params.work}`)
...
define("ui/view/debug/ButtonRegistry", ["require", "exports", "model/Session", "utility/Env"], function (require, exports, Session_15, Env_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.BUTTON_REGISTRY = {
        createAuthor: {
            ...
            async execute(name, vanity, description, pronouns) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}author/create`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                ...
                await Session_15.default.refresh();
            },
        },
        updateAuthor: {
            name: 'Update Author',
            async execute(name, description, vanity, support_link, support_message) {
                await fetch(`${Env_6.default.API_ORIGIN}author/update`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Accept': 'application/json',
        ...
        deleteAuthor: {
            name: 'Delete Author',
            async execute() {
                await fetch(`${Env_6.default.API_ORIGIN}author/delete`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        viewAuthor: {
            ...
            async execute(label, vanity) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}author/${vanity}/get`, {
                    credentials: 'include',
                }).then(response => response.json());
        ...
        clearSession: {
            name: 'Clear Session',
            async execute() {
                await fetch(`${Env_6.default.API_ORIGIN}session/reset`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Accept': 'application/json',
        ...
        createWork: {
            ...
            async execute(name, synopsis, description, vanity, status, visibility, globalTags, customTags) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}work/create`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        updateWork: {
            ...
            async execute(author, url, name, description, vanity, status, visibility) {
                await fetch(`${Env_6.default.API_ORIGIN}work/${author}/${url}/update`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        deleteWork: {
            ...
            async execute(author, url) {
                await fetch(`${Env_6.default.API_ORIGIN}work/${author}/${url}/delete`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        viewWork: {
            ...
            async execute(label, author, url) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}work/${author}/${url}/get`, {
                    credentials: 'include',
                }).then(response => response.json());
                console.log(label, response);
            },
        ...
        getAllWorksByAuthor: {
            ...
            async execute(label, author) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}works/${author}`, {
                    credentials: 'include',
                }).then(response => response.json());
                console.log(label, response);
            },
        ...
        createChapter: {
            ...
            async execute(author, work_url, name, body, visibility, is_numbered, notesBefore, notesAfter, globalTags, customTags) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}work/${author}/${work_url}/chapter/create`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        updateChapter: {
            ...
            async execute(author, work_url, index, name, body, visibility, is_numbered, notesBefore, notesAfter, globalTags, customTags) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}work/${author}/${work_url}/chapter/${index}/update`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        deleteChapter: {
            ...
            async execute(author, work_url, index) {
                await fetch(`${Env_6.default.API_ORIGIN}work/${author}/${work_url}/chapter/${index}/delete`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        viewChapter: {
            ...
            async execute(label, author, work_url, index) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}work/${author}/${work_url}/chapter/${index}/get`, {
                    credentials: 'include',
                }).then(response => response.json());
                console.log(label, response);
            },
        ...
        viewChapterPaginated: {
            ...
            async execute(label, author, work_url, index) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}work/${author}/${work_url}/chapters/individual?page=${index}`, {
                    credentials: 'include',
                }).then(response => response.json());
                console.log(label, response);
            },
        ...
        getAllChapters: {
            ...
            async execute(author, vanity, page = 0) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}work/${author}/${vanity}/chapters/list?page=${page}`, {
                    credentials: 'include',
                }).then(response => response.json());
                console.log(response);
            },
        ...
        follow: {
            ...
            async execute(type, vanity) {
                await fetch(`${Env_6.default.API_ORIGIN}follow/${type}/${vanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        followWork: {
            ...
            async execute(author_vanity, work_vanity) {
                await fetch(`${Env_6.default.API_ORIGIN}follow/work/${author_vanity}/${work_vanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        unfollow: {
            name: 'Unfollow',
            async execute(type, vanity) {
                await fetch(`${Env_6.default.API_ORIGIN}unfollow/${type}/${vanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        unfollowWork: {
            name: 'Unfollow',
            async execute(author_vanity, work_vanity) {
                await fetch(`${Env_6.default.API_ORIGIN}unfollow/work/${author_vanity}/${work_vanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        getFollow: {
            name: 'Get Follow',
            async execute(type, vanity) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}follows/${type}/${vanity}`, {
                    credentials: 'include',
                }).then(response => response.json());
                console.log(response);
            },
        ...
        getFollowWork: {
            name: 'Get Follow',
            async execute(author_vanity, work_vanity) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}follows/work/${author_vanity}/${work_vanity}`, {
                    credentials: 'include',
                }).then(response => response.json());
                console.log(response);
            },
        ...
        getAllFollows: {
            ...
            async execute(type, page = 0) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}following/${type}?page=${page}`, {
                    credentials: 'include',
                }).then(response => response.json());
                console.log(response);
            },
        ...
        getAllFollowsMerged: {
            ...
            async execute(page = 0) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}following?page=${page}`, {
                    credentials: 'include',
                }).then(response => response.json());
                console.log(response);
            },
        ...
        ignore: {
            name: 'Ignore',
            async execute(type, vanity) {
                await fetch(`${Env_6.default.API_ORIGIN}ignore/${type}/${vanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        ignoreWork: {
            name: 'Ignore',
            async execute(author_vanity, work_vanity) {
                await fetch(`${Env_6.default.API_ORIGIN}ignore/work/${author_vanity}/${work_vanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        unignore: {
            name: 'Unignore',
            async execute(type, vanity) {
                await fetch(`${Env_6.default.API_ORIGIN}unignore/${type}/${vanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        unignoreWork: {
            name: 'Unignore',
            async execute(author_vanity, work_vanity) {
                await fetch(`${Env_6.default.API_ORIGIN}unignore/work/${author_vanity}/${work_vanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        getIgnore: {
            name: 'Get Ignore',
            async execute(type, vanity) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}ignores/${type}/${vanity}`, {
                    credentials: 'include',
                }).then(response => response.json());
                console.log(response);
            },
        ...
        getIgnoreWork: {
            name: 'Get Ignore',
            async execute(author_vanity, work_vanity) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}ignores/work/${author_vanity}/${work_vanity}`, {
                    credentials: 'include',
                }).then(response => response.json());
                console.log(response);
            },
        ...
        getAllIgnores: {
            ...
            async execute(type, page = 0) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}ignoring/${type}?page=${page}`, {
                    credentials: 'include',
                }).then(response => response.json());
                console.log(response);
            },
        ...
        getAllIgnoresMerged: {
            ...
            async execute(page = 0) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}ignoring?page=${page}`, {
                    credentials: 'include',
                }).then(response => response.json());
                console.log(response);
            },
        ...
        privilegeGetAllAuthor: {
            ...
            async execute(label, vanity) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}privilege/get/${vanity}`, {
                    credentials: 'include',
                }).then(response => response.json());
                console.log(label, response);
            },
        ...
        privilegeGrantAuthor: {
            ...
            async execute(vanity, ...privileges) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}privilege/grant/author/${vanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        privilegeRevokeAuthor: {
            ...
            async execute(vanity, ...privileges) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}privilege/revoke/author/${vanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        createRole: {
            ...
            async execute(roleName, visibilty, roleBelow) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}role/create`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        deleteRole: {
            ...
            async execute(vanity) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}role/delete/${vanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        editRole: {
            ...
            async execute(vanity, name, description) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}role/update/${vanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        grantRoleToAuthor: {
            ...
            async execute(roleVanity, authorVanity) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}role/grant/${roleVanity}/${authorVanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        revokeRoleFromAuthor: {
            ...
            async execute(roleVanity, authorVanity) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}role/revoke/${roleVanity}/${authorVanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        privilegeGrantRole: {
            ...
            async execute(vanity, ...privileges) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}privilege/grant/role/${vanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        privilegeRevokeRole: {
            ...
            async execute(vanity, ...privileges) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}privilege/revoke/role/${vanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        roleListAll: {
            name: 'List all roles',
            async execute(label) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}role/get`, {
                    credentials: 'include',
                }).then(response => response.json());
                console.log(label, response);
            },
        ...
        roleReorder: {
            name: 'Reorder roles',
            async execute(...roles) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}role/reorder`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        createCommentChapter: {
            ...
            async execute(author, vanity, index, body, parent_id) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}work/${author}/${vanity}/chapter/${index}/comment/add`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        updateCommentChapter: {
            ...
            async execute(id, comment_body) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}comment/update/chapter`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        deleteCommentChapter: {
            ...
            async execute(id) {
                await fetch(`${Env_6.default.API_ORIGIN}comment/remove/chapter`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        getComment: {
            ...
            async execute(id, label) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}comment/get`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        getAllComments: {
            ...
            async execute(author, vanity, index) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}work/${author}/${vanity}/chapter/${index}/comments`, {
                    credentials: 'include',
                }).then(response => response.json());
                console.log(response);
            },
        ...
        patreonGetTiers: {
            name: 'Get Tiers',
            async execute(label) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}patreon/campaign/tiers/get`, {
                    credentials: 'include',
                }).then(response => response.json());
                console.log(label, response);
            },
        ...
        patreonSetThresholds: {
            ...
            async execute(author_vanity, work_vanity, visibility, chapters, tier_id) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}patreon/campaign/tiers/set/${author_vanity}/${work_vanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        tagCreateCategory: {
            ...
            async execute(categoryName, categoryDescription) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}tag/create/category`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        tagCreateGlobal: {
            ...
            async execute(tagName, tagDescription, tagCategory) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}tag/create/global`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        tagPromoteCustom: {
            ...
            async execute(tagName, newDescription, newCategory) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}tag/promote/${tagName}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        tagDemoteGlobal: {
            ...
            async execute(tagName) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}tag/demote/${tagName}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        tagUpdateCategory: {
            ...
            async execute(vanity, categoryName, categoryDescription) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}tag/update/category/${vanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        tagUpdateGlobal: {
            ...
            async execute(vanity, tagName, tagDescription, tagCategory) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}tag/update/global/${vanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        tagRemoveCategory: {
            ...
            async execute(vanity) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}tag/remove/category/${vanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        tagRemoveGlobal: {
            ...
            async execute(vanity) {
                const response = await fetch(`${Env_6.default.API_ORIGIN}tag/remove/global/${vanity}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        tagGetManifest: {
            ...
            async execute() {
                const response = await fetch(`${Env_6.default.API_ORIGIN}manifest/tags`, {
                    method: 'GET',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        manifestFormLengthGet: {
            ...
            async execute() {
                const response = await fetch(`${Env_6.default.API_ORIGIN}manifest/form/lengths`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                    },
        ...
        notificationsGet: {
            ...
            async execute() {
                const response = await fetch(`${Env_6.default.API_ORIGIN}notifications/get/all`, {
                    method: 'GET',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        notificationsGetUnread: {
            ...
            async execute() {
                const response = await fetch(`${Env_6.default.API_ORIGIN}notifications/get/unread`, {
                    method: 'GET',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        notificationsMark: {
            ...
            async execute(state, notifications) {
                await fetch(`${Env_6.default.API_ORIGIN}notifications/mark/${state}`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        seedBulk: {
            name: 'Seed Bulk',
            async execute() {
                await fetch(`${Env_6.default.API_ORIGIN}seed/bulk`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        feedGet: {
            name: 'Get Feed',
            async execute() {
                const response = await fetch(`${Env_6.default.API_ORIGIN}feed/get`, {
                    method: 'GET',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
...
define("ui/view/DebugView", ["require", "exports", "endpoint/auth/EndpointAuthServices", "model/Session", "ui/Component", "ui/component/core/Button", "ui/view/debug/ButtonRegistry", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "utility/Env", "utility/Objects", "utility/Popup"], function (require, exports, EndpointAuthServices_2, Session_16, Component_57, Button_20, ButtonRegistry_1, View_5, ViewDefinition_5, Env_7, Objects_6, Popup_1) {
    ...
    Objects_6 = __importDefault(Objects_6);
    Popup_1 = __importDefault(Popup_1);
    const Block = Component_57.default.Builder(component => component
        .style('debug-block'));
    exports.default = (0, ViewDefinition_5.default)({
        async create() {
            const view = (0, View_5.default)('debug');
            ...
            for (const service of Objects_6.default.values(OAuthServices.data ?? {})) {
                if (!service)
                    continue;
                (0, Button_20.default)()
                ...
                (0, Button_20.default)()
                    ...
                    .event.subscribe('click', async () => {
                    const id = Session_16.default.Auth.get(service.id)?.id;
                    if (id === undefined)
                        return;
                    await fetch(`${Env_7.default.API_ORIGIN}auth/remove`, {
                        method: 'POST',
                        credentials: 'include',
                        headers: {
                            'Accept': 'application/json',
            ...
            (0, Button_20.default)()
                ...
                .event.subscribe('click', async () => {
                await (0, Popup_1.default)('Campaign OAuth', `${Env_7.default.API_ORIGIN}auth/patreon/campaign/begin`, 600, 900)
                    .then(() => true).catch(err => { console.warn(err); return false; });
                await Session_16.default.refresh();
            })
            ...
            (0, Button_20.default)()
                ...
                .event.subscribe('click', async () => {
                await (0, Popup_1.default)('Patron OAuth', `${Env_7.default.API_ORIGIN}auth/patreon/patron/begin`, 600, 900)
                    .then(() => true).catch(err => { console.warn(err); return false; });
                await Session_16.default.refresh();
            })
                .appendTo(patreonButtons);
...
define("model/PagedData", ["require", "exports", "utility/State"], function (require, exports, State_40) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    State_40 = __importDefault(State_40);
    const PagedData = Object.assign(function (definition) {
        const pageCount = (0, State_40.default)(undefined);
        const pages = (0, State_40.default)([], false); // .setId('PagedData pages')
        return {
            pageCount,
            get pages() {
            ...
            get(page) {
                ...
                if (existing === undefined || existing === false) {
                    pages.value[page] = Promise.resolve(definition.get(page))
                        .then(data => {
                        if (!State_40.default.is(pages.value[page])) { // if it's already a State, it's been updated before this, don't overwrite
                            let newState;
                            if (State_40.default.is(data)) {
                                newState = (0, State_40.default)(null, false); // .setId(`PagedData page ${page} get 1`)
                                newState.bindManual(data);
                            }
                            else
                                newState = (0, State_40.default)(data, false); // .setId(`PagedData page ${page} get 2`)
            ...
            set(page, data, isLastPage) {
                if (State_40.default.is(pages.value[page]))
                    pages.value[page].value = data;
                else
                    pages.value[page] = (0, State_40.default)(data, false); // .setId(`PagedData page ${page} set`)
                if (isLastPage)
...
define("model/PagedListData", ["require", "exports", "model/PagedData", "utility/State"], function (require, exports, PagedData_1, State_41) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
            ...
            resized(resizePageSize) {
                ...
                list.rawPages.subscribeManual(() => {
                    ...
                    for (let i = 0; i < pages.length; i++) {
                        ...
                        function setPage(value) {
                            const state = pages[i] = (0, State_41.default)(null, false); // .setId('PagedListData subscribeManual setPage')
                            if (State_41.default.is(value))
                ...
                function getPage(page) {
                    ...
                    for (let i = startPageInSource; i < endPageInSource; i++) {
                        ...
                        if (i >= startPageInSource && i < endPageInSource && (!rawPage || (State_41.default.is(rawPage) && rawPage.value === false))) {
                ...
                function resolveData(sourcePages, startIndex, endIndex) {
                    ...
                    return State_41.default.Generator(() => data, false).observeManual(...sourcePages); // .setId('PagedListData resolveData')
                }
            },
            //#endregion
            ////////////////////////////////////
            ...
            async get(page) {
                ...
                if (dismantler) {
                    ...
                    for (const [key, value] of Object.entries(auxiliary)) {
                        if (value === content)
                            continue;
                        const state = aux[key] ??= (0, State_41.default)([]);
...
define("ui/component/core/Paginator2", ["require", "exports", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Slot", "utility/Async", "utility/State"], function (require, exports, Component_58, Block_12, Button_21, Slot_16, Async_4, State_42) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Paginator2 = Component_58.default.Builder((component) => {
        const block = component.and(Block_12.default);
        const isFlush = block.type.state.mapManual(type => type.has('flush'));
        block.style.bind(isFlush, 'paginator--flush');
        block.tweakJIT('header', header => {
            header.style('paginator-header')
        ...
        block.footer.left.style('paginator-footer-left');
        block.footer.right.style('paginator-footer-right');
        const cursor = (0, State_42.default)(0);
        const allData = (0, State_42.default)(undefined, false);
        ...
        const currentData = (0, State_42.default)(false, false);
        let settingId = Symbol();
        State_42.default.Use(component, { cursor, allData }).use(component, async ({ cursor, allData }) => {
            if (!allData)
        ...
        const isLastPage = State_42.default.Map(component, [cursor, pageCount], (cursor, pageCount) => cursor >= (pageCount ?? Infinity));
        // first
        (0, Button_21.default)()
            .setIcon('angles-left')
            .type('icon')
        ...
        (0, Slot_16.default)()
            ...
            const wrapper = (0, Slot_16.default)().appendTo(slot);
            const pages = [];
            cursor.use(slot, async (pageNumber, previousPageNumber) => {
                ...
                if (previousPageNumber !== undefined) {
                    ...
                    await Async_4.default.sleep(200);
            ...
            async function Page(pageNumber) {
                ...
                pageContent.use(slot, async (content) => {
                    ...
                    if (hasContent) {
                        initialiser?.(page, content, data, paginator);
                        return;
                    }
        ...
        return paginator;
        function RetryDialog(retry) {
            return (0, Component_58.default)()
                .style('paginator-error')
                .append((0, Component_58.default)()
                .style('paginator-error-text')
                .text.use('component/paginator/error'))
                .append((0, Button_21.default)()
                .type('primary')
                .style('paginator-error-retry-button')
                .text.use('component/paginator/error/retry')
                .event.subscribe('click', () => retry()));
    ...
    exports.default = Paginator2;
});
define("ui/component/WorkFeed", ["require", "exports", "model/PagedListData", "ui/Component", "ui/component/core/Link", "ui/component/core/Paginator2", "ui/component/Work", "utility/State"], function (require, exports, PagedListData_1, Component_59, Link_9, Paginator2_1, Work_3, State_43) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    PagedListData_1 = __importDefault(PagedListData_1);
    Component_59 = __importDefault(Component_59);
    Link_9 = __importDefault(Link_9);
    Paginator2_1 = __importDefault(Paginator2_1);
    Work_3 = __importDefault(Work_3);
    State_43 = __importDefault(State_43);
    const WorkFeed = Component_59.default.Builder((component) => {
        const paginator = component.and(Paginator2_1.default)
            .type('flush');
        const set = paginator.set;
        const feed = paginator.extend(feed => ({
            setFromEndpoint(endpoint) {
                const authors = (0, State_43.default)([]);
                const data = (0, PagedListData_1.default)(endpoint.getPageSize?.() ?? 25, {
                    async get(page) {
            ...
            setFromWorks(pagedData, authors) {
                set(pagedData, (slot, works) => {
                    for (const workData of works) {
                        ...
                        (0, Link_9.default)(author && `/work/${author.vanity}/${workData.vanity}`)
...
define("ui/component/core/Tabinator", ["require", "exports", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "utility/Objects", "utility/State"], function (require, exports, Component_60, Block_13, Button_23, Objects_7, State_44) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Tab = void 0;
    ...
    exports.Tab = Component_60.default.Builder((component) => {
        const content = (0, Component_60.default)()
            ...
            .ariaRole('tabpanel')
            .setRandomId();
        const tab = component.and(Button_23.default)
            .type('flush')
            .style('tabinator-tab')
            .ariaRole('tab')
            .setRandomId()
    ...
    const Tabinator = Component_60.default.Builder((component) => {
        const activeTab = (0, State_44.default)(undefined);
        const tabs = (0, State_44.default)([]);
        const tabinator = component
            ...
            addTab(newTab) {
                ...
                (0, Objects_7.mutable)(newTab).tabinator = tabinator;
...
define("ui/view/following/FollowingAuthorsTab", ["require", "exports", "endpoint/author/EndpointAuthorsResolveReferences", "model/Follows", "model/PagedListData", "ui/Component", "ui/component/Author", "ui/component/core/Link", "ui/component/core/Paginator2", "ui/component/core/Placeholder", "ui/component/core/Slot", "ui/component/core/Tabinator", "utility/AbortPromise", "utility/Arrays"], function (require, exports, EndpointAuthorsResolveReferences_1, Follows_4, PagedListData_2, Component_61, Author_2, Link_11, Paginator2_2, Placeholder_2, Slot_17, Tabinator_1, AbortPromise_5, Arrays_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Paginator2_2 = __importDefault(Paginator2_2);
    ...
    const FollowingAuthorsTab = Component_61.default.Builder((component, type) => {
        ...
        (0, Slot_17.default)()
            ...
            const authors = (0, PagedListData_2.default)(25, {
                async get(page) {
            ...
            await authors.get(0);
            (0, Paginator2_2.default)()
                .type('flush')
                .viewTransition(false)
                .set(authors, (slot, authors) => {
                for (const author of authors) {
                    (0, Link_11.default)(`/author/${author.vanity}`)
                        .and(Author_2.default, author)
                        .viewTransition(false)
                        .appendTo(slot);
                }
            })
                .orElse(slot => (0, Placeholder_2.default)()
...
define("ui/component/TagBlock", ["require", "exports", "lang/en-nz", "model/Follows", "model/Session", "model/Tags", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "ui/component/Tag"], function (require, exports, en_nz_12, Follows_5, Session_17, Tags_5, Component_62, Block_14, Button_24, Tag_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const TagBlock = Component_62.default.Builder((component, tag) => {
        const block = component
            .and(Block_14.default)
            .style('tag-block')
            .extend(tab => ({}));
        const id = Tags_5.default.toId(tag);
        block.header.style('tag-block-header');
        block.setActionsMenu(popover => {
            Session_17.default.Auth.loggedIn.use(popover, loggedIn => {
                if (!loggedIn)
                    return;
                (0, Button_24.default)()
                    .type('flush')
...
define("ui/view/following/FollowingTagsTab", ["require", "exports", "model/Follows", "model/Tags", "ui/Component", "ui/component/core/Link", "ui/component/core/Placeholder", "ui/component/core/Slot", "ui/component/core/Tabinator", "ui/component/TagBlock", "utility/AbortPromise", "utility/Arrays"], function (require, exports, Follows_6, Tags_6, Component_63, Link_12, Placeholder_3, Slot_18, Tabinator_2, TagBlock_1, AbortPromise_6, Arrays_7) {
    ...
    const FollowingTagsTab = Component_63.default.Builder((component, type) => {
        ...
        (0, Slot_18.default)()
            ...
            if (!tags.length)
                return (0, Placeholder_3.default)()
                    .text.use(`view/${type}/panel/tags/empty`)
                    .appendTo(slot);
            for (const tag of tags)
                (0, Link_12.default)(`/tag/${tag.category.toLowerCase()}/${tag.name.toLowerCase()}`)
...
define("ui/view/following/FollowingWorksTab", ["require", "exports", "endpoint/work/EndpointWorksResolveReferences", "model/Follows", "model/PagedListData", "ui/Component", "ui/component/core/Link", "ui/component/core/Paginator2", "ui/component/core/Placeholder", "ui/component/core/Slot", "ui/component/core/Tabinator", "ui/component/Work", "utility/AbortPromise", "utility/Arrays", "utility/State"], function (require, exports, EndpointWorksResolveReferences_1, Follows_7, PagedListData_3, Component_64, Link_13, Paginator2_3, Placeholder_4, Slot_19, Tabinator_3, Work_4, AbortPromise_7, Arrays_8, State_45) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Paginator2_3 = __importDefault(Paginator2_3);
    ...
    const FollowingWorksTab = Component_64.default.Builder((component, type) => {
        ...
        (0, Slot_19.default)()
            ...
            const authors = (0, State_45.default)([]);
            const works = (0, PagedListData_3.default)(25, {
                async get(page) {
                    const slice = follows.slice(page * 25, (page + 1) * 25) ?? [];
                    if (!slice.length)
                        return null;
                    const response = await EndpointWorksResolveReferences_1.default.query(undefined, { works: slice.map(follow => follow.work).filterInPlace(Arrays_8.NonNullish) });
                    if (toast.handleError(response))
                        return false;
                    authors.value.push(...response.data.authors);
                    authors.value.distinctInPlace(author => author.vanity);
            ...
            await works.get(0);
            (0, Paginator2_3.default)()
                .type('flush')
                .viewTransition(false)
                .set(works, (slot, works) => {
                for (const work of works) {
                    (0, Link_13.default)(`/work/${work.author}/${work.vanity}`)
                        .and(Work_4.default, work, authors.value.find(author => author.vanity === work.author), true)
                        .viewTransition(false)
                        .appendTo(slot);
                }
            })
                .orElse(slot => (0, Placeholder_4.default)()
...
define("ui/view/FollowingView", ["require", "exports", "ui/component/core/Tabinator", "ui/view/following/FollowingAuthorsTab", "ui/view/following/FollowingTagsTab", "ui/view/following/FollowingWorksTab", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition"], function (require, exports, Tabinator_4, FollowingAuthorsTab_1, FollowingTagsTab_1, FollowingWorksTab_1, View_7, ViewDefinition_7) {
    ...
    exports.default = (0, ViewDefinition_7.default)({
        create: () => {
            const view = (0, View_7.default)('following');
...
define("ui/view/HistoryView", ["require", "exports", "endpoint/history/EndpointHistoryGet", "model/Authors", "model/PagedListData", "model/Works", "ui/component/Chapter", "ui/component/core/Block", "ui/component/core/Link", "ui/component/core/Paginator2", "ui/component/Work", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition"], function (require, exports, EndpointHistoryGet_1, Authors_1, PagedListData_4, Works_3, Chapter_2, Block_15, Link_14, Paginator2_4, Work_5, View_8, ViewDefinition_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Paginator2_4 = __importDefault(Paginator2_4);
    ...
    exports.default = (0, ViewDefinition_8.default)({
        create: () => {
            const view = (0, View_8.default)('history');
            ...
            (0, Paginator2_4.default)()
                .type('flush')
                .set(PagedListData_4.default.fromEndpoint(25, EndpointHistoryGet_1.default.prep(), data => ({
                content: data.items,
                auxiliary: data,
            })), (slot, history, data) => {
                slot.style('history');
                ...
                for (let i = history.length - 1; i >= 0; i--) {
                    ...
                    if (item.chapter && !Works_3.default.equals(item.work, currentWork))
                ...
                for (const historyItem of history) {
                    const work = Works_3.default.resolve(historyItem.work, data.works.value);
                    const author = Authors_1.default.resolve(work?.author, data.authors.value);
                    if (!work || !author)
                        continue;
                    if (!historyItem.chapter) {
                        (0, Link_14.default)(`/work/${author.vanity}/${work.vanity}`)
                            .and(Work_5.default, { ...work, time_last_update: historyItem.view_time }, author)
                            .style('history-work')
                            .appendTo(slot);
                    ...
                    (0, Chapter_2.default)({ ...historyItem.chapter, time_last_update: historyItem.view_time }, work, author)
                        ...
                        .appendTo(currentChapterBlock ??= (0, Block_15.default)()
...
define("ui/view/IgnoringView", ["require", "exports", "ui/component/core/Tabinator", "ui/view/following/FollowingAuthorsTab", "ui/view/following/FollowingTagsTab", "ui/view/following/FollowingWorksTab", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition"], function (require, exports, Tabinator_5, FollowingAuthorsTab_2, FollowingTagsTab_2, FollowingWorksTab_2, View_9, ViewDefinition_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = (0, ViewDefinition_9.default)({
        create: () => {
            const view = (0, View_9.default)('ignoring');
...
define("ui/view/NewView", ["require", "exports", "endpoint/feed/EndpointFeedGet", "ui/component/WorkFeed", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition"], function (require, exports, EndpointFeedGet_1, WorkFeed_2, View_10, ViewDefinition_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = (0, ViewDefinition_10.default)({
        create: () => {
            const view = (0, View_10.default)('new');
            view.breadcrumbs.title.text.use('view/new/main/title');
            view.breadcrumbs.description.text.use('view/new/main/description');
            (0, WorkFeed_2.default)()
                .viewTransition('new-view-feed')
                .setFromEndpoint(EndpointFeedGet_1.default)
                .appendTo(view.content);
            return view;
        },
    });
});
define("endpoint/notification/EndpointNotificationMarkRead", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_42) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_42 = __importDefault(Endpoint_42);
    exports.default = (0, Endpoint_42.default)('/notifications/mark/read', 'post');
});
define("endpoint/notification/EndpointNotificationGetAll", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_43) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_43 = __importDefault(Endpoint_43);
    exports.default = (0, Endpoint_43.default)('/notifications/get/all', 'get');
});
define("endpoint/notification/EndpointNotificationGetCount", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_44) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_44 = __importDefault(Endpoint_44);
    exports.default = (0, Endpoint_44.default)('/notifications/get/count', 'get');
});
define("endpoint/notification/EndpointNotificationMarkUnread", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_45) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_45 = __importDefault(Endpoint_45);
    exports.default = (0, Endpoint_45.default)('/notifications/mark/unread', 'post');
});
define("model/Notifications", ["require", "exports", "endpoint/notification/EndpointNotificationGetAll", "endpoint/notification/EndpointNotificationGetCount", "endpoint/notification/EndpointNotificationMarkRead", "endpoint/notification/EndpointNotificationMarkUnread", "model/PagedListData", "model/Session", "utility/State", "utility/Store", "utility/Time"], function (require, exports, EndpointNotificationGetAll_1, EndpointNotificationGetCount_1, EndpointNotificationMarkRead_1, EndpointNotificationMarkUnread_1, PagedListData_5, Session_18, State_46, Store_3, Time_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Notifications) {
        Session_18.default.setClearedWithSessionChange('notifications', () => {
        ...
        const pageSize = 25;
        Notifications.cache = (0, PagedListData_5.default)(pageSize, {
            async get(page) {
        ...
        Notifications.authors = (0, State_46.default)(Store_3.default.items.notifications?.authors ?? []);
        Notifications.works = (0, State_46.default)(Store_3.default.items.notifications?.works ?? []);
        Notifications.chapters = (0, State_46.default)(Store_3.default.items.notifications?.chapters ?? []);
        Notifications.comments = (0, State_46.default)(Store_3.default.items.notifications?.comments ?? []);
        Notifications.hasMore = (0, State_46.default)(Store_3.default.items.notifications?.hasMore ?? false);
        Notifications.unreadCount = (0, State_46.default)(Store_3.default.items.notifications?.unreadCount ?? 0);
        Notifications.lastUpdate = (0, State_46.default)(Store_3.default.items.notifications?.lastUpdate ?? 0);
        function clear() {
        ...
        async function checkNotifications() {
            ...
            if (!Session_18.default.Auth.author.value)
                return;
...
define("ui/component/Notification", ["require", "exports", "lang/en-nz", "model/Authors", "model/Chapters", "model/Comments", "model/Notifications", "model/TextBody", "model/Works", "ui/Component", "ui/component/core/Button", "ui/component/core/Link", "ui/component/core/Timestamp", "utility/State"], function (require, exports, en_nz_13, Authors_2, Chapters_4, Comments_2, Notifications_1, TextBody_2, Works_4, Component_65, Button_25, Link_15, Timestamp_4, State_47) {
    ...
    const Notification = Component_65.default.Builder('a', (component, data) => {
        ...
        if (!translationFunction)
            return undefined;
        const read = (0, State_47.default)(data.read);
        ...
        const TRIGGERED_BY = !triggeredBy ? undefined : (0, Link_15.default)(`/author/${triggeredBy.vanity}`).text.set(triggeredBy.name);
        const author = Authors_2.default.resolve(data.author, Notifications_1.default.authors.value);
        const AUTHOR = !author ? undefined : (0, Link_15.default)(`/author/${author.vanity}`).text.set(author.name);
        const work = Works_4.default.resolve(data.work, Notifications_1.default.works.value);
        const WORK = !work ? undefined : (0, Link_15.default)(`/work/${work.author}/${work.vanity}`).text.set(work.name);
        const chapter = Chapters_4.default.resolve(data.chapter, Notifications_1.default.chapters.value);
        const CHAPTER = !chapter ? undefined : (0, Link_15.default)(`/work/${chapter.author}/${chapter.work}/chapter/${chapter.url}`).text.set(chapter.name);
        const justMarkedUnread = (0, State_47.default)(false);
        const readButton = (0, Button_25.default)()
            .setIcon('check')
            .type('icon')
        ...
        if (comment) {
            (0, Component_65.default)()
                ...
                .appendTo(notification);
            if (chapter)
                notification.and(Link_15.default, `/work/${chapter.author}/${chapter.work}/chapter/${chapter.url}`)
...
define("ui/component/NotificationList", ["require", "exports", "endpoint/notification/EndpointNotificationMarkRead", "model/Notifications", "ui/Component", "ui/component/core/Button", "ui/component/core/Paginator2", "ui/component/Notification"], function (require, exports, EndpointNotificationMarkRead_2, Notifications_2, Component_66, Button_26, Paginator2_5, Notification_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Paginator2_5 = __importDefault(Paginator2_5);
    ...
    const NotificationList = Component_66.default.Builder(async (component, onlyUnread, pageSize) => {
        const paginator = component.and(Paginator2_5.default)
...
define("ui/view/NotificationsView", ["require", "exports", "ui/component/NotificationList", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition"], function (require, exports, NotificationList_1, View_11, ViewDefinition_11) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = (0, ViewDefinition_11.default)({
        create: async () => {
            const view = (0, View_11.default)('notifications');
...
define("endpoint/feed/EndpointFeedGetAuthed", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_46) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_46 = __importDefault(Endpoint_46);
    exports.default = (0, Endpoint_46.default)('/feed/get/authed', 'get');
});
...
define("ui/view/TagView", ["require", "exports", "endpoint/feed/EndpointFeedGet", "endpoint/feed/EndpointFeedGetAuthed", "model/Session", "model/Tags", "ui/component/TagBlock", "ui/component/WorkFeed", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "utility/Errors"], function (require, exports, EndpointFeedGet_2, EndpointFeedGetAuthed_1, Session_19, Tags_7, TagBlock_2, WorkFeed_3, View_12, ViewDefinition_12, Errors_1) {
    ...
    exports.default = (0, ViewDefinition_12.default)({
        create: async (params) => {
            const view = (0, View_12.default)('tag');
            ...
            (0, WorkFeed_3.default)()
                .setFromEndpoint((Session_19.default.Auth.author.value ? EndpointFeedGetAuthed_1.default : EndpointFeedGet_2.default)
                .prep(undefined, {
...
define("ui/view/TestView", ["require", "exports", "markdown-it", "ui/Component", "ui/component/core/Block", "ui/component/core/TextEditor", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "utility/Env", "utility/string/MarkdownItHTML"], function (require, exports, markdown_it_2, Component_67, Block_16, TextEditor_4, View_13, ViewDefinition_13, Env_8, MarkdownItHTML_2) {
    ...
    exports.default = (0, ViewDefinition_13.default)({
        create: () => {
            const view = (0, View_13.default)('home');
            const block = (0, Block_16.default)().appendTo(view.content);
            ...
            (0, TextEditor_4.default)()
                .appendTo(block.content);
            if (Env_8.default.isDev) {
                (0, Component_67.default)('br').appendTo(block.content);
                const output = (0, Component_67.default)('div');
                (0, Component_67.default)('div')
...
define("ui/component/core/Textarea", ["require", "exports", "lang/en-nz", "ui/Component", "ui/component/core/ext/Input", "ui/utility/StringApplicator", "utility/State"], function (require, exports, en_nz_14, Component_68, Input_6, StringApplicator_6, State_48) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Textarea = Component_68.default.Builder((component) => {
        let shouldIgnoreInputEvent = false;
        const contenteditable = (0, Component_68.default)()
            .style('text-input', 'text-area')
            .attributes.set('contenteditable', 'plaintext-only')
            .ariaRole('textbox')
            .attributes.set('aria-multiline', 'true');
        const hiddenInput = (0, Component_68.default)('input')
            .style('text-area-validity-pipe-input')
            .tabIndex('programmatic')
            .attributes.set('type', 'text')
            .setName(`text-area-validity-pipe-input-${Math.random().toString(36).slice(2)}`);
        const state = (0, State_48.default)('');
        const input = component
            .and(Input_6.default)
...
define("ui/view/work/WorkEditForm", ["require", "exports", "endpoint/work/EndpointWorkCreate", "endpoint/work/EndpointWorkUpdate", "lang/en-nz", "model/FormInputLengths", "model/Session", "ui/Component", "ui/component/core/Block", "ui/component/core/Form", "ui/component/core/LabelledTable", "ui/component/core/RadioRow", "ui/component/core/Textarea", "ui/component/core/TextEditor", "ui/component/core/TextInput", "ui/component/core/toast/Toast", "ui/component/TagsEditor", "ui/component/VanityInput"], function (require, exports, EndpointWorkCreate_1, EndpointWorkUpdate_1, en_nz_15, FormInputLengths_5, Session_20, Component_69, Block_17, Form_3, LabelledTable_3, RadioRow_2, Textarea_1, TextEditor_5, TextInput_6, Toast_4, TagsEditor_2, VanityInput_2) {
    ...
    exports.default = Component_69.default.Builder((component, state) => {
        const block = component.and(Block_17.default);
        ...
        table.label(label => label.text.use('view/work-edit/shared/form/description/label'))
            .content((content, label) => content.append(descriptionInput.setLabel(label)));
        const synopsisInput = (0, TextEditor_5.default)()
            ...
            const response = await (() => {
                switch (type) {
                    ...
                    case 'update': {
                        if (!state.value)
                            return;
                        const authorVanity = Session_20.default.Auth.author.value?.vanity;
                        if (!authorVanity)
                            return new Error('Cannot update a work when not signed in');
...
define("ui/view/WorkEditView", ["require", "exports", "endpoint/work/EndpointWorkGet", "model/Works", "ui/component/core/ActionRow", "ui/component/core/Button", "ui/component/core/InfoDialog", "ui/component/core/Slot", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "ui/view/shared/ext/ViewTransition", "ui/view/work/WorkEditForm", "utility/State"], function (require, exports, EndpointWorkGet_2, Works_5, ActionRow_6, Button_27, InfoDialog_2, Slot_20, View_14, ViewDefinition_14, ViewTransition_4, WorkEditForm_1, State_49) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = (0, ViewDefinition_14.default)({
        ...
        create: async (params) => {
            const id = 'work-edit';
            const view = (0, View_14.default)(id);
            const work = params && await EndpointWorkGet_2.default.query({ params });
            if (work instanceof Error)
                throw work;
            if (!work?.data)
                await InfoDialog_2.default.prompt(view, {
                    titleTranslation: 'shared/prompt/beta-restrictions/title',
                    bodyTranslation: 'shared/prompt/beta-restrictions/description',
                });
            const state = (0, State_49.default)(work?.data);
            const stateInternal = (0, State_49.default)(work?.data);
            if (params && work)
                view.breadcrumbs.setBackButton(`/work/${params.author}/${params.vanity}`, button => button.subText.set(work.data.name));
            (0, Slot_20.default)()
...
define("ui/view/WorkView", ["require", "exports", "endpoint/chapter/EndpointChapterGetAll", "endpoint/chapter/EndpointChapterReorder", "endpoint/history/EndpointHistoryAddWork", "endpoint/work/EndpointWorkGet", "model/PagedListData", "model/Session", "ui/Component", "ui/component/Chapter", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Paginator2", "ui/component/core/Placeholder", "ui/component/core/Slot", "ui/component/Work", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "utility/Errors", "utility/State"], function (require, exports, EndpointChapterGetAll_1, EndpointChapterReorder_1, EndpointHistoryAddWork_1, EndpointWorkGet_3, PagedListData_6, Session_21, Component_70, Chapter_3, Block_18, Button_28, Paginator2_6, Placeholder_5, Slot_21, Work_6, View_15, ViewDefinition_15, Errors_2, State_50) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Paginator2_6 = __importDefault(Paginator2_6);
    ...
    exports.default = (0, ViewDefinition_15.default)({
        create: async (params) => {
            const view = (0, View_15.default)('work');
            ...
            (0, Work_6.default)(workData, authorData)
                .viewTransition('work-view-work')
                .setContainsHeading()
                .appendTo(view.content);
            const movingChapter = (0, State_50.default)(undefined);
            const chaptersListState = (0, State_50.default)(null);
            (0, Slot_21.default)()
                .use(chaptersListState, () => (0, Paginator2_6.default)()
                ...
                (0, Slot_21.default)()
                    ...
                    (0, Chapter_3.default)(movingChapterData, workData, authorData)
                        ...
                        .insertAction('reorder', 'before', 'delete', Session_21.default.Auth.author, (slot, self) => true
                ...
                .set(PagedListData_6.default.fromEndpoint(25, EndpointChapterGetAll_1.default.prep({
                params: {
                ...
                .orElse(slot => (0, Block_18.default)()
                .type('flush')
                .tweak(block => (0, Placeholder_5.default)()
                .text.use('view/work/chapters/content/empty')
                .appendTo(block.content))
                .appendTo(slot))
                .setActionsMenu(popover => popover
                .append((0, Slot_21.default)()
                .if(Session_21.default.Auth.author.map(popover, author => author?.vanity === params.author), () => (0, Button_28.default)()
                .setIcon('plus')
                .type('flush')
...
define("navigation/Routes", ["require", "exports", "navigation/Route", "ui/view/AccountView", "ui/view/AuthorView", "ui/view/ChapterEditView", "ui/view/ChapterView", "ui/view/DebugView", "ui/view/FeedView", "ui/view/FollowingView", "ui/view/HistoryView", "ui/view/IgnoringView", "ui/view/NewView", "ui/view/NotificationsView", "ui/view/TagView", "ui/view/TestView", "ui/view/WorkEditView", "ui/view/WorkView", "utility/Env"], function (require, exports, Route_1, AccountView_1, AuthorView_1, ChapterEditView_1, ChapterView_1, DebugView_1, FeedView_1, FollowingView_1, HistoryView_1, IgnoringView_1, NewView_1, NotificationsView_1, TagView_1, TestView_1, WorkEditView_1, WorkView_1, Env_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    TestView_1 = __importDefault(TestView_1);
    ...
    const Routes = [
        ...
        (0, Route_1.default)('/', Env_9.default.isDev ? NewView_1.default.navigate : TestView_1.default.navigate),
...
define("ui/utility/StringApplicator", ["require", "exports", "lang/en-nz", "utility/State"], function (require, exports, en_nz_16, State_51) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function BaseStringApplicator(host, defaultValue, set) {
        ...
        function makeApplicator(host) {
            return {
                state: (0, State_51.default)(defaultValue),
                set: value => {
                    unbind?.();
...
define("ui/component/core/Button", ["require", "exports", "ui/Component", "ui/utility/FontsListener", "ui/utility/TypeManipulator", "utility/State", "utility/Type"], function (require, exports, Component_71, FontsListener_1, TypeManipulator_3, State_52, Type_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Button = Component_71.default.Builder('button', (component) => {
        ...
        const disabled = State_52.default.Generator(() => !!disabledReasons.size);
        const hasSubtext = (0, State_52.default)(false);
        let icon;
        ...
        const button = component
            ...
            unbindDisabled(state, reason) {
                ...
                button.setDisabled(false, reason ?? Type_1.default.as('string', state.value) ?? '');
                return button;
            },
            setIcon(newIcon) {
                unuseIconState?.();
...
define("ui/component/core/Label", ["require", "exports", "ui/Component", "ui/component/core/Button", "ui/component/core/Form", "ui/view/shared/component/View", "utility/State"], function (require, exports, Component_72, Button_29, Form_4, View_16, State_53) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Label = Component_72.default.Builder('label', (label) => {
        ...
        const textWrapper = (0, Component_72.default)()
            .style('label-text')
            .appendTo(label);
        const infoButton = (0, Button_29.default)()
        ...
        return label
            .extend(label => ({
            textWrapper,
            for: (0, State_53.default)(undefined),
            setFor: inputName => {
    ...
    exports.AutoLabel = Component_72.default.Builder('label', (component) => {
        ...
        label.event.subscribe(['insert', 'ancestorInsert'], () => {
            ...
            const view = label.closest(View_16.default);
...
define("ui/Component", ["require", "exports", "lang/en-nz", "ui/utility/AnchorManipulator", "ui/utility/AttributeManipulator", "ui/utility/ClassManipulator", "ui/utility/EventManipulator", "ui/utility/FocusListener", "ui/utility/StringApplicator", "ui/utility/StyleManipulator", "ui/utility/TextManipulator", "ui/utility/Viewport", "utility/Arrays", "utility/Async", "utility/Define", "utility/Env", "utility/Errors", "utility/State", "utility/string/Strings"], function (require, exports, en_nz_18, AnchorManipulator_3, AttributeManipulator_1, ClassManipulator_1, EventManipulator_1, FocusListener_2, StringApplicator_9, StyleManipulator_1, TextManipulator_2, Viewport_5, Arrays_9, Async_5, Define_5, Env_10, Errors_3, State_54, Strings_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function Component(type = 'span') {
        ...
        let component = {
            supers: (0, State_54.default)([]),
            isComponent: true,
            isInsertionDestination: true,
            element: document.createElement(type),
            removed: (0, State_54.default)(false),
            rooted: (0, State_54.default)(false),
            get tagName() {
            ...
            get event() {
                return Define_5.default.set(component, 'event', (0, EventManipulator_1.default)(component));
            },
            get text() {
            ...
            get hovered() {
                return Define_5.default.set(component, 'hovered', (0, State_54.default)(false));
            },
            get focused() {
                return Define_5.default.set(component, 'focused', (0, State_54.default)(false));
            },
            get hasFocused() {
                return Define_5.default.set(component, 'hasFocused', (0, State_54.default)(false));
            },
            get hadFocusedLast() {
                return Define_5.default.set(component, 'hadFocusedLast', (0, State_54.default)(false));
            },
            get hoveredOrFocused() {
                return Define_5.default.set(component, 'hoveredOrFocused', State_54.default.Generator(() => component.hovered.value || component.focused.value)
                    .observe(component, component.hovered, component.focused));
            },
            get hoveredOrHasFocused() {
                return Define_5.default.set(component, 'hoveredOrHasFocused', State_54.default.Generator(() => component.hovered.value || component.hasFocused.value)
                    .observe(component, component.hovered, component.hasFocused));
            },
            get active() {
                return Define_5.default.set(component, 'active', (0, State_54.default)(false));
            },
            get id() {
                return Define_5.default.set(component, 'id', (0, State_54.default)(undefined));
            },
            get name() {
                return Define_5.default.set(component, 'name', (0, State_54.default)(undefined));
            },
            get rect() {
                const rectState = State_54.default.JIT(() => component.element.getBoundingClientRect());
                ...
                Viewport_5.default.size.subscribe(component, rectState.markDirty);
            ...
            *getDescendants(builder) {
            ...
            ariaLabelledBy: labelledBy => {
                ...
                if (labelledBy) {
                    const state = State_54.default.Generator(() => labelledBy.id.value ?? labelledBy.attributes.get('for'))
    ...
    (function (Component) {
        ...
        function Builder(initialOrBuilder, builder) {
            ...
            async function ensureOriginalComponentNotSubscriptionOwner(original) {
                if (!original || !State_54.default.OwnerMetadata.hasSubscriptions(original))
                    return;
                const originalRef = new WeakRef(original);
                original = undefined;
                await Async_5.default.sleep(1000);
...
define("model/Session", ["require", "exports", "endpoint/auth/EndpointAuthDelete", "endpoint/session/EndpointSessionGet", "endpoint/session/EndpointSessionReset", "utility/Env", "utility/Popup", "utility/State", "utility/Store"], function (require, exports, EndpointAuthDelete_1, EndpointSessionGet_1, EndpointSessionReset_1, Env_11, Popup_2, State_55, Store_4) {
    ...
    (function (Session) {
        ...
        let Auth;
        (function (Auth) {
            Auth.state = (0, State_55.default)('none');
            Auth.loggedIn = State_55.default.Generator(() => Auth.state.value === 'logged-in').observeManual(Auth.state);
            Auth.authorisations = (0, State_55.default)([]);
            Auth.author = (0, State_55.default)(undefined, (a, b) => a?.vanity === b?.vanity);
            function getAll() {
            ...
            async function requestDangerToken(type, service) {
                ...
                const result = await (0, Popup_2.default)(`Re-authenticate Using ${service.name}`, `${Env_11.default.API_ORIGIN}danger-token/request/${type}/${service.id}/begin`, 600, 900)
                    .then(() => true).catch(err => { console.warn(err); return false; });
...
define("model/Manifest", ["require", "exports", "model/Session", "utility/State", "utility/Time"], function (require, exports, Session_22, State_56, Time_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function Manifest(definition) {
        ...
        const state = (0, State_56.default)(undefined, false);
        tryLoad();
        const result = Object.assign(state, {
            ...
            async getManifest(force) {
                ...
                if (!force && result.isFresh(state.value))
                    return state.value;
                if (definition.requiresAuthor && !Session_22.default.Auth.loggedIn.value)
                    return undefined;
...
define("ui/view/ErrorView", ["require", "exports", "lang/en-nz", "ui/component/core/Heading", "ui/component/core/Paragraph", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition"], function (require, exports, en_nz_19, Heading_3, Paragraph_3, View_17, ViewDefinition_16) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = (0, ViewDefinition_16.default)({
        create: (params) => {
            const view = (0, View_17.default)('error');
    ...
    const ViewContainer = () => {
        ...
        const container = (0, Component_73.default)()
            ...
            show: async (definition, params) => {
                ...
                const needsLogin = definition.requiresLogin && !Session_23.default.Auth.loggedIn.value;
                if (needsLogin || definition.load) {
                    ...
                    await loginPromise;
                    if (needsLogin && !Session_23.default.Auth.loggedIn.value) {
                        let setLoggedIn;
                        ...
                        ViewTransition_5.default.perform('view', async () => {
                            ...
                            if (!view)
                                return;
                            Session_23.default.Auth.loggedIn.subscribe(view, loggedIn => loggedIn && setLoggedIn());
                        });
                        await loggedIn;
                    }
                }
        ...
        function logIn() {
            if (Session_23.default.Auth.author.value)
                return;
            ...
            const authPromise = accountViewShown.then(async (view) => {
                ...
                await Promise.race([
                    Session_23.default.Auth.await(view),
                    loginCancelledPromise,
                ]);
                cancelLogin = undefined;
                return Session_23.default.Auth.loggedIn.value;
            });
            return {
                accountViewShown,
                authed: authPromise,
...
define("navigation/Navigate", ["require", "exports", "navigation/Routes", "ui/utility/EventManipulator", "ui/view/ErrorView", "utility/Env"], function (require, exports, Routes_1, EventManipulator_2, ErrorView_2, Env_12) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function Navigator() {
        ...
        const navigate = {
            ...
            setURL: (url) => {
                if (url !== location.pathname)
                    history.pushState({}, '', `${Env_12.default.URL_ORIGIN}${url.slice(1)}`);
            },
            toRawURL: (url) => {
        ...
        navigate.event = (0, EventManipulator_2.default)(navigate);
        // eslint-disable-next-line @typescript-eslint/no-misused-promises
...
define("ui/component/PrimaryNav", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/Heading", "ui/component/core/Link", "ui/component/core/Slot", "ui/utility/StringApplicator", "utility/Env"], function (require, exports, Session_24, Component_75, Button_32, Heading_4, Link_16, Slot_22, StringApplicator_10, Env_13) {
    ...
    exports.default = Component_75.default.Builder(nav => {
        ...
        Group('top', 'sidebar/section/browse')
            ...
            .using(Session_24.default.Auth.author, (group, author) => group
            ...
            .setDisabled(!author, 'no author')));
        (0, Slot_22.default)()
            .use(Session_24.default.Auth.author, (slot, author) => author
        ...
        Group('bottom', 'sidebar/section/profile')
            .using(Session_24.default.Auth.author, (group, author) => {
            if (author)
                group
        ...
        if (Env_13.default.ENVIRONMENT === 'dev')
...
define("ui/component/Masthead", ["require", "exports", "model/Notifications", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/Link", "ui/component/core/Slot", "ui/component/masthead/Flag", "ui/component/NotificationList", "ui/component/PrimaryNav", "ui/component/Sidebar", "ui/utility/Viewport", "utility/AbortPromise", "utility/Env"], function (require, exports, Notifications_3, Session_25, Component_77, Button_33, Link_17, Slot_23, Flag_1, NotificationList_2, PrimaryNav_1, Sidebar_1, Viewport_6, AbortPromise_8, Env_14) {
    ...
    Button_33 = __importDefault(Button_33);
    ...
    const Masthead = Component_77.default.Builder('header', (masthead, view) => {
        ...
        let sizeTimeout;
        Viewport_6.default.size.use(masthead, () => {
        ...
        const homeLink = (0, Link_17.default)('/')
            ...
            .ariaHidden()
            .attributes.set('src', `${Env_14.default.URL_ORIGIN}image/logo-wordmark.svg`)))
            .appendTo(left);
        ...
        (0, Slot_23.default)()
            .style.remove('slot')
            .style('masthead-user')
            .if(Session_25.default.Auth.loggedIn, () => (0, Component_77.default)()
            ////////////////////////////////////
            ...
            for (const action of list.paginator.primaryActions.getChildren())
                if (action.is(Button_33.default))
                    action.style('masthead-user-notifications-list-action');
            (0, Link_17.default)('/notifications')
                .and(Button_33.default)
                .type('flush')
            ...
            .style('action-group')
            .style.remove('slot')
            .use(Session_25.default.Auth.author, (slot, author) => {
            if (!author)
                return;
            (0, Link_17.default)(`/author/${author.vanity}`)
                .and(Button_33.default)
                .type('flush')
            ...
            (0, Button_33.default)()
                ...
                .text.use('view/account/action/logout')
                .event.subscribe('click', () => Session_25.default.reset())
                .appendTo(slot);
        }))))
        //#endregion
        ////////////////////////////////////
        )
            .else(() => (0, Button_33.default)()
...
define("ui/component/Mention", ["require", "exports", "lang/en-nz", "ui/Component", "ui/component/core/Link", "ui/utility/MarkdownContent"], function (require, exports, en_nz_20, Component_78, Link_18, MarkdownContent_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Mention = Component_78.default.Builder('a', (component, author) => {
        return component
            .and(Link_18.default, author && `/author/${author.vanity}`)
...
define("App", ["require", "exports", "lang/en-nz", "model/FormInputLengths", "model/Session", "navigation/Navigate", "style", "ui/Component", "ui/component/core/ExternalLink", "ui/component/core/Link", "ui/component/core/toast/ToastList", "ui/component/Masthead", "ui/component/Mention", "ui/InputBus", "ui/utility/ActiveListener", "ui/utility/FocusListener", "ui/utility/FontsListener", "ui/utility/HoverListener", "ui/utility/Mouse", "ui/utility/StringApplicator", "ui/utility/Viewport", "ui/view/shared/component/ViewContainer", "utility/Async", "utility/DevServer", "utility/Store", "utility/Time"], function (require, exports, en_nz_21, FormInputLengths_6, Session_26, Navigate_1, style_2, Component_79, ExternalLink_2, Link_19, ToastList_1, Masthead_1, Mention_1, InputBus_2, ActiveListener_1, FocusListener_3, FontsListener_2, HoverListener_2, Mouse_5, StringApplicator_11, Viewport_7, ViewContainer_1, Async_6, DevServer_2, Store_6, Time_12) {
    ...
    Async_6 = __importDefault(Async_6);
    ...
    async function App() {
        ...
        await Promise.race([
            Session_26.default.refresh(),
            Async_6.default.sleep(Time_12.default.seconds(2)),
        ]);
...
define("index", ["require", "exports", "utility/Arrays", "utility/DOMRect", "utility/Elements", "browser-source-map-support", "utility/Env", "utility/Maps"], function (require, exports, Arrays_11, DOMRect_1, Elements_1, browser_source_map_support_1, Env_15, Maps_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/component/core/ActionHeading", ["require", "exports", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/Heading"], function (require, exports, Component_80, ActionRow_8, Heading_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_80 = __importDefault(Component_80);
    ActionRow_8 = __importDefault(ActionRow_8);
    Heading_5 = __importDefault(Heading_5);
    const ActionHeading = Component_80.default.Builder((component) => {
        const row = component.and(ActionRow_8.default)
