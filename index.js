    ...
    (function (State) {
        ...
        function Generator(generate) {
            ...
            result.observe = (owner, ...states) => {
                ...
                let unuseOwnerRemove = owner.removed.subscribeManual(removed => removed && onRemove());
                return result;
                function onRemove() {
                    unuseOwnerRemove?.();
...
define("ui/utility/StyleManipulator", ["require", "exports", "style", "utility/State"], function (require, exports, style_1, State_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/component/core/Button", ["require", "exports", "ui/Component", "utility/State", "utility/Type"], function (require, exports, Component_2, State_2, Type_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Button = Component_2.default.Builder('button', (button) => {
        ...
        const disabled = State_2.default.Generator(() => !!disabledReasons.size);
        let icon;
...
define("ui/utility/FocusListener", ["require", "exports", "utility/State"], function (require, exports, State_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    State_3 = __importDefault(State_3);
    var FocusListener;
    (function (FocusListener) {
        FocusListener.hasFocus = (0, State_3.default)(false);
        FocusListener.focused = (0, State_3.default)(undefined);
        FocusListener.focusedLast = (0, State_3.default)(undefined);
...
define("ui/utility/Mouse", ["require", "exports", "utility/State"], function (require, exports, State_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Mouse) {
        const pos = { x: 0, y: 0 };
        Mouse.state = (0, State_4.default)(pos);
...
define("ui/component/core/Popover", ["require", "exports", "ui/Component", "ui/InputBus", "ui/utility/FocusListener", "ui/utility/HoverListener", "ui/utility/Mouse", "utility/State", "utility/Task"], function (require, exports, Component_4, InputBus_1, FocusListener_1, HoverListener_1, Mouse_2, State_5, Task_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Popover = Component_4.default.Builder((component) => {
        let mousePadding;
        let unbind;
        const visible = (0, State_5.default)(false);
        ...
        const popover = component
            ...
            .extend(popover => ({
            visible,
            popoverChildren: (0, State_5.default)([]),
            popoverParent: (0, State_5.default)(undefined),
...
define("ui/utility/MarkdownContent", ["require", "exports", "ui/Component", "utility/string/Markdown"], function (require, exports, Component_6, Markdown_1) {
    ...
    Component_6.default.extend(component => component.extend(component => ({
        setMarkdownContent(markdown) {
            ...
            component.element.innerHTML = Markdown_1.default.render(markdown);
...
define("ui/utility/StringApplicator", ["require", "exports", "lang/en-nz", "utility/State"], function (require, exports, en_nz_1, State_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (QuiltHelper) {
        let Break;
        function setComponent(ComponentFunction) {
            Break = ComponentFunction
                .Builder('br', component => component.style('break'))
                .setName('Break');
        }
        QuiltHelper.setComponent = setComponent;
    ...
    function BaseStringApplicator(host, defaultValue, set) {
        ...
        function makeApplicator(host) {
            return {
                state: (0, State_6.default)(defaultValue),
                set: value => {
                    unbind?.();
...
define("ui/utility/TextManipulator", ["require", "exports", "ui/utility/StringApplicator"], function (require, exports, StringApplicator_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    StringApplicator_1 = __importDefault(StringApplicator_1);
    function TextManipulator(component, target = component) {
        return Object.assign(StringApplicator_1.default.Nodes(component, nodes => {
            target.removeContents();
            target.append(...nodes);
            return nodes;
        }), {
            prepend(text) {
                target.prepend(...StringApplicator_1.default.render(text));
                return component;
            },
            append(text) {
                target.append(...StringApplicator_1.default.render(text));
                return component;
            },
        });
    }
...
define("ui/component/core/Heading", ["require", "exports", "ui/Component", "ui/utility/MarkdownContent", "ui/utility/TextManipulator", "utility/Define", "utility/maths/Maths", "utility/State"], function (require, exports, Component_7, MarkdownContent_1, TextManipulator_1, Define_3, Maths_1, State_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Heading = Component_7.default.Builder('h1', (component) => {
        ...
        let aestheticLevel;
        let aestheticStyle;
        const resizeRange = (0, State_7.default)(undefined);
        State_7.default.Map(component, [component.text.state, resizeRange], (...args) => args)
            ...
            const size = Maths_1.default.lerp(0.5, 1, t);
...
define("ui/component/core/Block", ["require", "exports", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/ext/CanHasActionsMenuButton", "ui/component/core/Heading", "ui/component/core/Paragraph", "utility/State"], function (require, exports, Component_9, ActionRow_1, CanHasActionsMenuButton_1, Heading_1, Paragraph_1, State_8) {
    ...
    const Block = Component_9.default.Builder((component) => {
        const types = (0, State_8.default)(new Set());
        let header;
        let footer;
...
define("ui/component/core/ext/ComponentInsertionTransaction", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/component/core/Slot", ["require", "exports", "ui/Component", "ui/component/core/ext/ComponentInsertionTransaction", "utility/AbortPromise", "utility/State"], function (require, exports, Component_10, ComponentInsertionTransaction_1, AbortPromise_1, State_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Slot = Object.assign(Component_10.default.Builder((slot) => {
        ...
        return slot
            ...
            use: (state, initialiser) => {
                ...
                unuse = state.use(slot, value => {
                    ...
                    abortTransaction?.();
                    abortTransaction = undefined;
                    const component = (0, Component_10.default)();
        ...
        using: (value, initialiser) => Slot().use(State_9.default.get(value), initialiser),
    });
    exports.default = Slot;
});
define("ui/component/core/ProgressWheel", ["require", "exports", "lang/en-nz", "ui/Component", "ui/component/core/Slot", "utility/State"], function (require, exports, en_nz_2, Component_11, Slot_1, State_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const ProgressWheelBuilder = Component_11.default.Builder((component) => {
        return component
            ...
            set(definition) {
                ...
                (0, Component_11.default)()
                    ...
                    .appendTo(wheel);
                const label = (0, Component_11.default)()
    ...
    const ProgressWheel = Object.assign(ProgressWheelBuilder, {
        Length(length, maxLength) {
            const unusedPercent = State_10.default.MapManual([length, maxLength], (length, maxLength) => length === undefined || !maxLength ? undefined : 1 - length / maxLength);
            const unusedChars = State_10.default.MapManual([length, maxLength], (length, maxLength) => length === undefined || !maxLength ? undefined : maxLength - length);
            return Slot_1.default.using(State_10.default.UseManual({ unusedPercent, unusedChars }), (slot, { unusedPercent, unusedChars }) => unusedPercent === undefined || unusedChars === undefined ? undefined
                : ProgressWheelBuilder()
                    .set({
                    progress: unusedPercent,
                    label: en_nz_2.default['shared/form/progress-wheel/remaining/label'](unusedChars),
        ...
        Progress(progress) {
            return ProgressWheelBuilder()
                .set({
                progress,
                label: progress.mapManual(p => en_nz_2.default['shared/form/progress-wheel/progress/label']((p ?? 0) * 100)),
            });
        },
    });
    exports.default = ProgressWheel;
});
define("ui/utility/Viewport", ["require", "exports", "utility/State"], function (require, exports, State_11) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    State_11 = __importDefault(State_11);
    var Viewport;
    (function (Viewport) {
        Viewport.size = State_11.default.JIT(() => ({ w: window.innerWidth, h: window.innerHeight }));
        function listen() {
...
define("ui/component/core/ext/Input", ["require", "exports", "ui/Component", "ui/component/core/Block", "ui/component/core/Popover", "ui/component/core/ProgressWheel", "ui/component/core/Slot", "ui/utility/AnchorManipulator", "ui/utility/StringApplicator", "utility/State"], function (require, exports, Component_12, Block_1, Popover_1, ProgressWheel_1, Slot_2, AnchorManipulator_1, StringApplicator_2, State_12) {
    ...
    function createHintText(hint) {
        return (0, Component_12.default)()
            .style('input-popover-hint-text')
            .text.bind(hint);
    }
    const Input = Object.assign(Component_12.default.Extension((component) => {
        const hintText = (0, State_12.default)(undefined);
        const maxLength = (0, State_12.default)(undefined);
        const length = (0, State_12.default)(undefined);
        const invalid = (0, State_12.default)('');
        const popoverOverride = (0, State_12.default)(false);
        const hasPopover = State_12.default.MapManual([hintText, maxLength, popoverOverride], (hintText, maxLength, override) => override || !!hintText || !!maxLength);
        let popover;
        hasPopover.subscribeManual(hasPopover => {
            ...
            popover = (0, Popover_1.default)()
                ...
                if (popoverOverride.value)
                    return;
                Slot_2.default.using(hintText, (slot, hintText) => !hintText ? undefined : createHintText(hintText))
                    .appendTo(popover);
        ...
        const customInvalidMessage = (0, State_12.default)(undefined);
        ...
        const input = component.extend(component => ({
            required: (0, State_12.default)(false),
...
define("ui/component/core/Form", ["require", "exports", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/Block", "ui/component/core/Button", "utility/State"], function (require, exports, Component_13, ActionRow_2, Block_2, Button_2, State_13) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Form = Component_13.default.Builder((component, label) => {
        const form = (component.replaceElement('form')
            .style('form')
            .ariaRole('form')
            .ariaLabelledBy(label));
        form.receiveDescendantInsertEvents();
        const valid = State_13.default.Generator(() => (form.element).checkValidity());
        form.event.subscribe(['input', 'change', 'descendantInsert'], () => valid.refresh());
        const content = (form.is(Block_2.default) ? form.content : (0, Component_13.default)())
            .style('form-content');
        ...
        return form
            ...
            .appendTo(submitButtonWrapper ??= (0, Component_13.default)()
            ...
            .style.bind(State_13.default.Every(form, submitButtonWrapper.hovered, submitButton.disabled), 'button--disabled--hover')
            .style.bind(State_13.default.Every(form, submitButtonWrapper.active, submitButton.disabled), 'button--disabled--active')));
    });
    exports.default = Form;
});
define("ui/view/shared/component/View", ["require", "exports", "ui/Component"], function (require, exports, Component_14) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_14 = __importDefault(Component_14);
    const View = Component_14.default.Builder((_, id) => (0, Component_14.default)()
...
define("ui/component/core/Label", ["require", "exports", "ui/Component", "ui/component/core/Form", "ui/view/shared/component/View", "utility/State"], function (require, exports, Component_15, Form_1, View_1, State_14) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Label = Component_15.default.Builder('label', (label) => {
        label.style('label');
        let requiredState;
        let unuseInput;
        return label
            .extend(label => ({
            for: (0, State_14.default)(undefined),
            setFor: inputName => {
    ...
    let globalI = 0;
    exports.AutoLabel = Component_15.default.Builder('label', (component) => {
        const i = globalI++;
...
define("ui/utility/AttributeManipulator", ["require", "exports", "lang/en-nz", "ui/utility/StringApplicator"], function (require, exports, en_nz_3, StringApplicator_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        const result = {
            ...
            refresh() {
                ...
                for (const attribute in translationHandlers) {
                    ...
                    const weave = typeof translationHandler === 'string' ? en_nz_3.default[translationHandler]() : translationHandler(en_nz_3.default, StringApplicator_3.QuiltHelper);
...
define("ui/Component", ["require", "exports", "ui/utility/AnchorManipulator", "ui/utility/AttributeManipulator", "ui/utility/ClassManipulator", "ui/utility/EventManipulator", "ui/utility/FocusListener", "ui/utility/StringApplicator", "ui/utility/StyleManipulator", "ui/utility/TextManipulator", "ui/utility/Viewport", "utility/Arrays", "utility/Async", "utility/Define", "utility/Env", "utility/Errors", "utility/State", "utility/string/Strings"], function (require, exports, AnchorManipulator_2, AttributeManipulator_1, ClassManipulator_1, EventManipulator_1, FocusListener_2, StringApplicator_4, StyleManipulator_1, TextManipulator_2, Viewport_2, Arrays_3, Async_2, Define_4, Env_2, Errors_1, State_15, Strings_2) {
    ...
    StringApplicator_4 = __importStar(StringApplicator_4);
    ...
    Define_4.default.magic(Element.prototype, 'component', {
        get() {
    ...
    function Component(type = 'span') {
        ...
        let component = {
            supers: (0, State_15.default)([]),
            isComponent: true,
            isInsertionDestination: true,
            element: document.createElement(type),
            removed: (0, State_15.default)(false),
            rooted: (0, State_15.default)(false),
            get tagName() {
            ...
            is: (builder) => !builder || component.supers.value.includes(builder),
            ...
            extendMagic: (property, magic) => {
                Define_4.default.magic(component, property, magic(component));
                return component;
            },
            extendJIT: (property, supplier) => {
                Define_4.default.magic(component, property, {
                    get: () => {
                        const value = supplier(component);
                        Define_4.default.set(component, property, value);
                        return value;
                    },
                    set: value => {
                        Define_4.default.set(component, property, value);
            ...
            get style() {
                return Define_4.default.set(component, 'style', (0, StyleManipulator_1.default)(component));
            },
            get classes() {
                return Define_4.default.set(component, 'classes', (0, ClassManipulator_1.default)(component));
            },
            get attributes() {
                return Define_4.default.set(component, 'attributes', (0, AttributeManipulator_1.default)(component));
            },
            get event() {
                return Define_4.default.set(component, 'event', (0, EventManipulator_1.default)(component));
            },
            get text() {
                return Define_4.default.set(component, 'text', (0, TextManipulator_2.default)(component));
            },
            get anchor() {
                return Define_4.default.set(component, 'anchor', (0, AnchorManipulator_2.default)(component));
            },
            get hovered() {
                return Define_4.default.set(component, 'hovered', (0, State_15.default)(false));
            },
            get focused() {
                return Define_4.default.set(component, 'focused', (0, State_15.default)(false));
            },
            get hasFocused() {
                return Define_4.default.set(component, 'hasFocused', (0, State_15.default)(false));
            },
            get hadFocusedLast() {
                return Define_4.default.set(component, 'hadFocusedLast', (0, State_15.default)(false));
            },
            get hoveredOrFocused() {
                return Define_4.default.set(component, 'hoveredOrFocused', State_15.default.Generator(() => component.hovered.value || component.focused.value)
                    .observe(component, component.hovered, component.focused));
            },
            get hoveredOrHasFocused() {
                return Define_4.default.set(component, 'hoveredOrHasFocused', State_15.default.Generator(() => component.hovered.value || component.hasFocused.value)
                    .observe(component, component.hovered, component.hasFocused));
            },
            get active() {
                return Define_4.default.set(component, 'active', (0, State_15.default)(false));
            },
            get id() {
                return Define_4.default.set(component, 'id', (0, State_15.default)(undefined));
            },
            get name() {
                return Define_4.default.set(component, 'name', (0, State_15.default)(undefined));
            },
            get rect() {
                const rectState = State_15.default.JIT(() => component.element.getBoundingClientRect());
                ...
                return Define_4.default.set(component, 'rect', rectState);
            },
            setId: id => {
                unuseIdState?.();
            ...
            append(...contents) {
                const elements = contents.filter(Arrays_3.default.filterFalsy).map(Component.element);
            ...
            *getDescendants(builder) {
            ...
            get ariaLabel() {
                return Define_4.default.set(component, 'ariaLabel', (0, StringApplicator_4.default)(component, value => component.attributes.set('aria-label', value)));
            },
            ariaLabelledBy: labelledBy => {
                unuseAriaLabelledByIdState?.();
                if (labelledBy) {
                    const state = State_15.default.Generator(() => labelledBy.id.value ?? labelledBy.attributes.get('for'))
    ...
    (function (Component) {
        ...
        function Builder(initialOrBuilder, builder) {
            ...
            async function ensureOriginalComponentNotSubscriptionOwner(original) {
                if (!original || !State_15.default.OwnerMetadata.hasSubscriptions(original))
                    return;
                const originalRef = new WeakRef(original);
                original = undefined;
                await Async_2.default.sleep(1000);
        ...
        function getBuilderName() {
            const stack = Strings_2.default.shiftLine((new Error().stack ?? ''), 3);
    ...
    StringApplicator_4.QuiltHelper.setComponent(Component);
    exports.default = Component;
});
define("utility/Store", ["require", "exports", "utility/State"], function (require, exports, State_16) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class Store {
        ...
        static get state() {
            ...
            return statesProxy ??= new Proxy({}, {
                ...
                get(_, key) {
                    return s[key] ??= (0, State_16.default)(Store.get(key));
                },
            });
        }
        static get full() {
...
define("model/Session", ["require", "exports", "endpoint/auth/EndpointAuthRemove", "endpoint/session/EndpointSessionGet", "endpoint/session/EndpointSessionReset", "utility/Env", "utility/Popup", "utility/State", "utility/Store"], function (require, exports, EndpointAuthRemove_1, EndpointSessionGet_1, EndpointSessionReset_1, Env_3, Popup_1, State_17, Store_2) {
    ...
    (function (Session) {
        ...
        let Auth;
        (function (Auth) {
            Auth.state = (0, State_17.default)('none');
            Auth.loggedIn = State_17.default.Generator(() => Auth.state.value === 'logged-in').observeManual(Auth.state);
            Auth.authorisations = (0, State_17.default)([]);
            Auth.author = (0, State_17.default)(undefined, (a, b) => a?.vanity === b?.vanity);
            function getAll() {
...
define("ui/component/core/Dialog", ["require", "exports", "ui/Component", "utility/State"], function (require, exports, Component_16, State_18) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_16 = __importDefault(Component_16);
    State_18 = __importDefault(State_18);
    const Dialog = Component_16.default.Builder(() => {
        const opened = (0, State_18.default)(false);
        const willOpen = (0, State_18.default)(false);
        const willClose = (0, State_18.default)(false);
        let modal = true;
        let unbind;
        const dialog = (0, Component_16.default)('dialog')
            .style('dialog')
...
define("ui/component/core/BlockDialog", ["require", "exports", "ui/Component", "ui/component/core/Block", "ui/component/core/Dialog", "utility/Task"], function (require, exports, Component_17, Block_3, Dialog_1, Task_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const BlockDialog = Component_17.default.Builder((component) => {
...
define("ui/component/core/Checkbutton", ["require", "exports", "ui/Component", "ui/component/core/Button", "utility/State"], function (require, exports, Component_18, Button_3, State_19) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_18 = __importDefault(Component_18);
    Button_3 = __importDefault(Button_3);
    State_19 = __importDefault(State_19);
    const Checkbutton = Component_18.default.Builder('label', (component) => {
        const input = (0, Component_18.default)('input')
            .style('checkbutton-input')
            .attributes.set('type', 'checkbox');
        const inputElement = input.element;
        const state = (0, State_19.default)(false);
        let unuse;
...
define("ui/component/OAuthService", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/Checkbutton", "utility/State"], function (require, exports, Session_1, Component_19, Checkbutton_1, State_20) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const OAuthService = Component_19.default.Builder((component, service, reauthDangerToken) => {
        ...
        const isAuthed = State_20.default.Truthy(component, authorisationState);
        const button = component
            ...
            .append((0, Component_19.default)('img')
            .style('oauth-service-icon')
            .attributes.set('src', service.icon))
            .append((0, Component_19.default)()
        ...
        if (!reauthDangerToken)
            (0, Component_19.default)()
                .style('oauth-service-state')
                .style.bind(isAuthed, 'oauth-service-state--authenticated')
                .style.bind(State_20.default.Map(button, [button.hoveredOrFocused, button.disabled], (focus, disabled) => focus && !disabled), 'oauth-service-state--focus')
                .appendTo((0, Component_19.default)()
                .style('oauth-service-state-wrapper')
                .style.bind(button.hoveredOrFocused, 'oauth-service-state-wrapper--focus')
                .appendTo(button));
        const username = (0, Component_19.default)()
...
define("ui/component/OAuthServices", ["require", "exports", "endpoint/auth/EndpointAuthServices", "model/Session", "ui/Component", "ui/component/core/Block", "ui/component/OAuthService", "utility/Objects", "utility/State"], function (require, exports, EndpointAuthServices_1, Session_2, Component_20, Block_4, OAuthService_1, Objects_2, State_21) {
    ...
    const OAuthServices = Component_20.default.Builder(async (component, state, reauthDangerToken) => {
        const block = component
            .and(Block_4.default)
        ...
        const list = (0, Component_20.default)()
...
define("ui/component/core/ConfirmDialog", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/BlockDialog", "ui/component/core/Button", "ui/component/core/Paragraph", "ui/component/OAuthServices", "utility/State"], function (require, exports, Session_3, Component_21, BlockDialog_1, Button_4, Paragraph_2, OAuthServices_1, State_22) {
    ...
    const ConfirmDialog = Object.assign(Component_21.default.Builder(async (component, definition) => {
        const dialog = component.and(BlockDialog_1.default);
        const state = (0, State_22.default)(undefined);
...
define("ui/component/core/LabelledRow", ["require", "exports", "ui/Component", "ui/component/core/Label"], function (require, exports, Component_22, Label_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_22 = __importDefault(Component_22);
    const LabelledRow = Component_22.default.Builder((row) => {
        row.style('labelled-row');
        let label = (0, Label_1.AutoLabel)().style('labelled-row-label').appendTo(row);
        let content = (0, Component_22.default)().style('labelled-row-content').appendTo(row);
        return row
            .extend(row => ({
            label, content,
        }))
            ...
            set: newLabel => {
                if (label === newLabel)
                    return;
                Component_22.default.removeContents(label.element);
            ...
            set: newContent => {
                if (content === newContent)
                    return;
                Component_22.default.removeContents(content.element);
...
define("ui/component/core/LabelledTable", ["require", "exports", "ui/Component", "ui/component/core/LabelledRow"], function (require, exports, Component_23, LabelledRow_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_23 = __importDefault(Component_23);
    LabelledRow_1 = __importDefault(LabelledRow_1);
    const LabelledTable = Component_23.default.Builder((table) => {
...
define("ui/component/core/TextInput", ["require", "exports", "lang/en-nz", "ui/Component", "ui/component/core/ext/Input", "ui/utility/StringApplicator", "utility/State"], function (require, exports, en_nz_4, Component_24, Input_1, StringApplicator_5, State_23) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const TextInput = Component_24.default.Builder('input', (component) => {
        ...
        input.event.subscribe(['input', 'change'], event => {
            ...
            if (input.length.value > (input.maxLength.value ?? Infinity))
                invalid = en_nz_4.default['shared/form/invalid/too-long']();
...
define("ui/component/core/TextInputBlock", ["require", "exports", "ui/Component", "ui/component/core/TextInput"], function (require, exports, Component_25, TextInput_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_25 = __importDefault(Component_25);
    TextInput_1 = __importDefault(TextInput_1);
    const TextInputBlock = Component_25.default.Builder((component) => {
        const inputs = [];
        const block = component
            ...
            addInput: (initialiser) => {
                const input = (0, TextInput_1.default)()
                    ...
                    .appendTo((0, Component_25.default)()
...
define("ui/component/core/LabelledTextInputBlock", ["require", "exports", "ui/Component", "ui/component/core/Label", "ui/component/core/TextInputBlock"], function (require, exports, Component_26, Label_2, TextInputBlock_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_26 = __importDefault(Component_26);
    TextInputBlock_1 = __importDefault(TextInputBlock_1);
    const LabelledTextInputBlock = Component_26.default.Builder((block) => {
        block.style('labelled-text-input-block', 'labelled-row')
            .ariaRole('group');
        const labels = (0, Component_26.default)()
...
define("ui/Announcer", ["require", "exports", "ui/Component"], function (require, exports, Component_27) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_27 = __importDefault(Component_27);
    var Announcer;
    (function (Announcer) {
        const assertive = (0, Component_27.default)()
            ...
            .appendTo(document.body);
        const polite = (0, Component_27.default)()
        ...
        function announceInternal(within, id, announcer) {
            ...
            announcer(keyOrHandler => {
                components.push((0, Component_27.default)('p')
...
define("ui/component/core/RadioButton", ["require", "exports", "ui/Component", "ui/component/core/Checkbutton"], function (require, exports, Component_28, Checkbutton_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_28 = __importDefault(Component_28);
    Checkbutton_2 = __importDefault(Checkbutton_2);
    exports.default = Component_28.default.Builder(() => {
...
define("ui/view/shared/ext/ViewTransition", ["require", "exports", "ui/Component", "utility/Arrays"], function (require, exports, Component_29, Arrays_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (ViewTransition) {
        ...
        const PADDING = 100;
        Component_29.default.extend(component => component.extend(component => ({
            viewTransition(name) {
                if (name) {
        ...
        function getComponents(type, name) {
            return [...document.querySelectorAll(`[${type === 'view' ? DATA_VIEW_TRANSITION_NAME : DATA_SUBVIEW_TRANSITION_NAME}${name ? `="${name}"` : ''}]`)]
                .map(e => e.component)
                .filter(Arrays_4.default.filterNullish);
        }
    })(ViewTransition || (ViewTransition = {}));
    exports.default = ViewTransition;
});
define("ui/component/core/TextEditor", ["require", "exports", "lang/en-nz", "model/Session", "prosemirror-commands", "prosemirror-dropcursor", "prosemirror-example-setup", "prosemirror-gapcursor", "prosemirror-history", "prosemirror-inputrules", "prosemirror-keymap", "prosemirror-markdown", "prosemirror-model", "prosemirror-schema-list", "prosemirror-state", "prosemirror-transform", "prosemirror-view", "ui/Announcer", "ui/Component", "ui/component/core/Button", "ui/component/core/Checkbutton", "ui/component/core/Dialog", "ui/component/core/ext/Input", "ui/component/core/Popover", "ui/component/core/RadioButton", "ui/component/core/Slot", "ui/utility/StringApplicator", "ui/utility/Viewport", "ui/view/shared/ext/ViewTransition", "utility/Arrays", "utility/Define", "utility/Objects", "utility/State", "utility/Store", "utility/string/Markdown", "utility/Time", "w3c-keyname"], function (require, exports, en_nz_5, Session_4, prosemirror_commands_1, prosemirror_dropcursor_1, prosemirror_example_setup_1, prosemirror_gapcursor_1, prosemirror_history_1, prosemirror_inputrules_1, prosemirror_keymap_1, prosemirror_markdown_1, prosemirror_model_1, prosemirror_schema_list_1, prosemirror_state_1, prosemirror_transform_1, prosemirror_view_1, Announcer_1, Component_30, Button_5, Checkbutton_3, Dialog_2, Input_2, Popover_2, RadioButton_1, Slot_3, StringApplicator_6, Viewport_3, ViewTransition_1, Arrays_5, Define_5, Objects_3, State_24, Store_3, Markdown_2, Time_5, w3c_keyname_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (0, Define_5.default)(prosemirror_model_1.ResolvedPos.prototype, 'closest', function (node, attrsOrStartingAtDepth, startingAtDepth) {
    ...
    (0, Define_5.default)(prosemirror_model_1.Node.prototype, 'matches', function (type, attrs) {
        if (type !== undefined && this.type !== type)
            return false;
        return attrs === undefined || this.hasAttrs(attrs);
    });
    (0, Define_5.default)(prosemirror_model_1.Node.prototype, 'hasAttrs', function (attrs) {
        for (const [attr, val] of Object.entries(attrs))
            if (this.attrs[attr] !== val)
                return false;
        return true;
    });
    (0, Define_5.default)(prosemirror_model_1.Node.prototype, 'pos', function (document) {
        if (document === this)
            return 0;
        let result;
    ...
    (0, Define_5.default)(prosemirror_model_1.Node.prototype, 'parent', function (document) {
        if (document === this)
            return undefined;
    ...
    (0, Define_5.default)(prosemirror_model_1.Node.prototype, 'depth', function (document) {
        if (document === this)
            return 0;
        // eslint-disable-next-line @typescript-eslint/no-this-alias
        const searchNode = this;
    ...
    (0, Define_5.default)(prosemirror_model_1.Fragment.prototype, 'pos', function (document) {
        let result;
        document.descendants((node, pos) => {
            if (result !== undefined)
                return false;
    ...
    (0, Define_5.default)(prosemirror_model_1.Fragment.prototype, 'range', function (document) {
    ...
    (0, Define_5.default)(prosemirror_model_1.Fragment.prototype, 'parent', function (document) {
    ...
    (0, Define_5.default)(prosemirror_transform_1.Transform.prototype, 'stripNodeType', function (from, type) {
        // eslint-disable-next-line @typescript-eslint/no-this-alias
        const tr = this;
    ...
    const schema = new prosemirror_model_1.Schema({
        nodes: Objects_3.default.filterNullish({
            ...
            heading: {
                ...
                content: 'text*',
                toDOM(node) {
                    const heading = (0, Component_30.default)(`h${node.attrs.level}`);
    ...
    let globalid = 0;
    const TextEditor = Component_30.default.Builder((component) => {
        const id = globalid++;
        const isMarkdown = (0, State_24.default)(false);
        const content = (0, State_24.default)('');
        const isFullscreen = (0, State_24.default)(false);
        // eslint-disable-next-line prefer-const
        let editor;
        const state = (0, State_24.default)(undefined);
        ////////////////////////////////////
        ...
        ////////////////////////////////////
        //#region Types
        const ToolbarButtonTypeMark = Component_30.default.Extension((component, type) => {
        ...
        const ToolbarButtonTypeNode = Component_30.default.Extension((component, type) => {
        ...
        const ToolbarButtonTypeOther = Component_30.default.Extension((component, type) => {
            return component
                .style(`text-editor-toolbar-${type}`)
                .ariaLabel.use(`component/text-editor/toolbar/button/${type}`);
        });
        ...
        ////////////////////////////////////
        //#region Components
        const ToolbarButtonGroup = Component_30.default.Builder(component => component
            .ariaRole('group')
            .style('text-editor-toolbar-button-group'));
        const ToolbarButton = Component_30.default.Builder((_, handler) => {
        ...
        const ToolbarCheckbutton = Component_30.default.Builder((_, state, toggler) => {
        ...
        const ToolbarRadioButton = Component_30.default.Builder((_, name, state, toggler) => {
        ...
        const ToolbarButtonPopover = Component_30.default.Builder((_, align) => {
            return (0, Button_5.default)()
        ...
        ////////////////////////////////////
        //#region Specifics
        const ToolbarButtonMark = Component_30.default.Builder((_, type) => {
            const mark = schema.marks[type];
        ...
        const ToolbarButtonAlign = Component_30.default.Builder((_, align) => {
        ...
        const ToolbarButtonBlockType = Component_30.default.Builder((_, type) => {
            const node = schema.nodes[type.replaceAll('-', '_')];
        ...
        const ToolbarButtonHeading = Component_30.default.Builder((_, level) => {
        ...
        const ToolbarButtonWrap = Component_30.default.Builder((_, type) => ToolbarButton(wrapper(schema.nodes[type.replaceAll('-', '_')]))
            .and(ToolbarButtonTypeNode, type));
        const ToolbarButtonList = Component_30.default.Builder((_, type) => ToolbarButton(listWrapper(schema.nodes[type.replaceAll('-', '_')]))
            .and(ToolbarButtonTypeNode, type));
        //#endregion
        ...
        types();
        ////////////////////////////////////
        const toolbar = (0, Component_30.default)()
            ...
            state.use(button, () => {
                ...
                button.ariaLabel.set(en_nz_5.default['component/text-editor/toolbar/button/align'](en_nz_5.default[`component/text-editor/toolbar/button/align/currently/${align}`]()).toString());
            ...
            state.use(button, () => {
                ...
                button.ariaLabel.set(en_nz_5.default['component/text-editor/toolbar/button/block-type'](en_nz_5.default[`component/text-editor/toolbar/button/block-type/currently/${blockType}`]()).toString());
            ...
            .ariaLabel.bind(isFullscreen.map(component, fullscreen => en_nz_5.default[`component/text-editor/toolbar/button/${fullscreen ? 'unfullscreen' : 'fullscreen'}`]().toString())))));
        //#endregion
        vars(toolbar);
        ////////////////////////////////////
        ////////////////////////////////////
        ...
        const hiddenInput = (0, Component_30.default)('input')
        ...
        const actualEditor = (0, Component_30.default)()
            .subviewTransition(viewTransitionName)
            .style('text-editor')
            .style.bind(isFullscreen, 'text-editor--fullscreen')
            .event.subscribe('click', event => {
            const target = Component_30.default.get(event.target);
        ...
        const documentSlot = (0, Slot_3.default)();
        documentSlot
            ...
            return createDefaultView((0, Slot_3.default)().appendTo(slot));
        })
            .appendTo(actualEditor);
        const contentWidth = State_24.default.Generator(() => `${editor.document?.element.scrollWidth ?? 0}px`)
            .observe(component, state, Viewport_3.default.size);
        const scrollbarProxy = (0, Component_30.default)()
            ...
            .appendTo(actualEditor);
        const fullscreenContentWidth = State_24.default.Generator(() => `${documentSlot.element.scrollWidth ?? 0}px`)
            .observe(component, state, Viewport_3.default.size);
        ...
        editor.length.use(editor, (length = 0) => {
            ...
            if (length > (editor.maxLength.value ?? Infinity))
                invalid = en_nz_5.default['shared/form/invalid/too-long']();
        ...
        function createDefaultView(slot) {
            ...
            editor.mirror = view;
            editor.document = (0, Component_30.default)()
                .and(Input_2.default)
...
define("ui/component/core/toast/ToastList", ["require", "exports", "ui/Component", "utility/Async", "utility/Task", "utility/Time"], function (require, exports, Component_31, Async_3, Task_3, Time_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const ToastComponent = Component_31.default.Builder((component) => {
        const title = (0, Component_31.default)()
            .style('toast-title')
            .appendTo(component);
        return component
            .style('toast')
            ...
            .extendJIT('content', toast => (0, Component_31.default)()
            .style('toast-content')
            .appendTo(toast));
    }).setName('Toast');
    const ToastList = Component_31.default.Builder((component) => {
        ...
        async function lifecycle(toast, component) {
            const wrapper = (0, Component_31.default)().style('toast-wrapper').appendTo(toasts);
            ...
            await Async_3.default.sleep(toast.duration);
            ...
            await Promise.race([
                ...
                Async_3.default.sleep(Time_6.default.seconds(1)),
            ]);
            return;
            wrapper.remove();
        }
...
define("ui/component/core/toast/Toast", ["require", "exports", "ui/Component"], function (require, exports, Component_32) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/component/VanityInput", ["require", "exports", "ui/Component", "ui/component/core/ext/Input", "ui/component/core/TextInput"], function (require, exports, Component_33, Input_3, TextInput_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const VanityInput = Component_33.default.Builder((component) => {
...
define("ui/view/account/AccountViewForm", ["require", "exports", "endpoint/author/EndpointAuthorCreate", "endpoint/author/EndpointAuthorUpdate", "lang/en-nz", "model/FormInputLengths", "model/Session", "ui/Component", "ui/component/core/Block", "ui/component/core/Form", "ui/component/core/LabelledTable", "ui/component/core/LabelledTextInputBlock", "ui/component/core/TextEditor", "ui/component/core/TextInput", "ui/component/core/toast/Toast", "ui/component/VanityInput"], function (require, exports, EndpointAuthorCreate_1, EndpointAuthorUpdate_1, en_nz_6, FormInputLengths_1, Session_5, Component_34, Block_5, Form_2, LabelledTable_1, LabelledTextInputBlock_1, TextEditor_1, TextInput_3, Toast_1, VanityInput_1) {
    ...
    exports.default = Component_34.default.Builder((component, type) => {
        ...
        form.setName(en_nz_6.default[`view/account/${type}/title`]().toString());
        if (type === 'create')
...
define("ui/view/AccountView", ["require", "exports", "endpoint/author/EndpointAuthorDelete", "model/Session", "ui/component/core/ActionRow", "ui/component/core/Button", "ui/component/core/ConfirmDialog", "ui/component/core/Slot", "ui/component/OAuthServices", "ui/view/account/AccountViewForm", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "ui/view/shared/ext/ViewTransition", "utility/State"], function (require, exports, EndpointAuthorDelete_1, Session_6, ActionRow_3, Button_6, ConfirmDialog_1, Slot_4, OAuthServices_2, AccountViewForm_1, View_2, ViewDefinition_1, ViewTransition_2, State_25) {
    ...
    exports.default = (0, ViewDefinition_1.default)({
        create: async () => {
            ...
            const state = (0, State_25.default)(Session_6.default.Auth.state.value);
            (0, Slot_4.default)()
...
define("ui/component/Author", ["require", "exports", "ui/Component", "ui/component/core/Block", "ui/component/core/ExternalLink", "ui/component/core/Slot"], function (require, exports, Component_36, Block_6, ExternalLink_1, Slot_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = Component_36.default.Builder((component, author) => {
        component
        ...
        block.description
            .append((0, Component_36.default)()
            .style('author-vanity')
            .text.set(`@${author.vanity}`))
            .append(author.pronouns && (0, Slot_5.default)()
            .text.append(' · ')
            .append((0, Component_36.default)()
            .style('author-pronouns')
            .text.set(author.pronouns)));
        (0, Component_36.default)()
            .style('author-description')
            .append((0, Slot_5.default)().tweak(slot => {
...
define("ui/component/core/Link", ["require", "exports", "ui/Component", "utility/Env", "utility/State"], function (require, exports, Component_37, Env_4, State_26) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_37 = __importDefault(Component_37);
    Env_4 = __importDefault(Env_4);
    State_26 = __importDefault(State_26);
    const Link = Component_37.default.Builder('a', (component, route) => {
        component.style('link');
        const canNavigate = (0, State_26.default)(true);
        if (route !== undefined) {
...
define("ui/component/core/Paginator", ["require", "exports", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Slot", "utility/Async", "utility/State"], function (require, exports, Component_38, Block_7, Button_7, Slot_6, Async_4, State_27) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/component/Tag", ["require", "exports", "ui/Component", "ui/component/core/Button", "ui/component/core/ext/Draggable", "ui/component/core/Link"], function (require, exports, Component_42, Button_8, Draggable_1, Link_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/component/Work", ["require", "exports", "model/FormInputLengths", "model/Session", "model/Tags", "ui/Component", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Link", "ui/component/core/Slot", "ui/component/core/TextLabel", "ui/component/core/Timestamp", "ui/component/Tag", "utility/AbortPromise"], function (require, exports, FormInputLengths_2, Session_7, Tags_1, Component_43, Block_8, Button_9, Link_2, Slot_7, TextLabel_1, Timestamp_1, Tag_1, AbortPromise_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Work = Component_43.default.Builder((component, work, author, notFullOverride) => {
        ...
        block.title
            .style('work-name')
            .text.set(work.name)
            .setResizeRange(32, FormInputLengths_2.default.manifest?.work.name);
        if (author)
            block.description
        ...
        (0, Slot_7.default)()
            ...
            return tags?.length && (0, Component_43.default)()
            ...
            .appendTo(block.content);
        (0, Slot_7.default)()
            .use(work.custom_tags, (slot, customTags) => customTags && (0, Component_43.default)()
    ...
    exports.default = (0, ViewDefinition_2.default)({
        create: async (params) => {
            ...
            const paginator = (0, Paginator_1.default)()
                ...
                .tweak(p => p.primaryActions.append((0, Slot_8.default)()
            ...
            await paginator.useEndpoint(worksQuery, (slot, works) => slot.append(...works.map(workData => (0, Link_3.default)(`/work/${author.data.vanity}/${workData.vanity}`)
                ...
                .type('flush')
                .appendTo(slot))));
            paginator.orElse(slot => (0, Component_44.default)()
                .style('placeholder')
...
define("ui/view/chapter/ChapterEditForm", ["require", "exports", "endpoint/chapter/EndpointChapterCreate", "endpoint/chapter/EndpointChapterUpdate", "lang/en-nz", "model/FormInputLengths", "model/Session", "ui/Component", "ui/component/core/Block", "ui/component/core/Form", "ui/component/core/LabelledTable", "ui/component/core/TextEditor", "ui/component/core/TextInput", "ui/component/core/toast/Toast"], function (require, exports, EndpointChapterCreate_1, EndpointChapterUpdate_1, en_nz_7, FormInputLengths_3, Session_9, Component_45, Block_9, Form_3, LabelledTable_2, TextEditor_2, TextInput_4, Toast_2) {
    ...
    exports.default = Component_45.default.Builder((component, state, workParams) => {
        ...
        form.setName(en_nz_7.default[`view/chapter-edit/${type}/title`]().toString());
        ...
        const nameInput = (0, TextInput_4.default)()
            ...
            .setMaxLength(FormInputLengths_3.default.manifest?.chapter.name);
    ...
    exports.default = (0, ViewDefinition_3.default)({
        ...
        create: async (params) => {
            ...
            if (chapter instanceof Error)
                throw chapter;
            const state = (0, State_30.default)(chapter?.data);
            const stateInternal = (0, State_30.default)(chapter?.data);
            (0, Slot_9.default)()
...
define("endpoint/comment/EndpointCommentGetAllUnder", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_17) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_17 = __importDefault(Endpoint_17);
    exports.default = (0, Endpoint_17.default)('/comments/{under}', 'get');
});
define("endpoint/comment/EndpointCommentAdd", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_18) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_18 = __importDefault(Endpoint_18);
    exports.default = (0, Endpoint_18.default)('/comment/add/{under}', 'post');
});
define("endpoint/comment/EndpointCommentRemove", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_19) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_19 = __importDefault(Endpoint_19);
    exports.default = (0, Endpoint_19.default)('/comment/{id}/remove', 'post');
});
define("endpoint/comment/EndpointCommentUpdate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_20) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_20 = __importDefault(Endpoint_20);
    exports.default = (0, Endpoint_20.default)('/comment/{id}/update', 'post');
});
define("endpoint/reaction/EndpointReactComment", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_21) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_21 = __importDefault(Endpoint_21);
    exports.default = (0, Endpoint_21.default)('/comment/{comment_id}/react/{type}', 'post');
});
define("endpoint/reaction/EndpointUnreactComment", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_22) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_22 = __importDefault(Endpoint_22);
    exports.default = (0, Endpoint_22.default)('/comment/{comment_id}/unreact', 'post');
});
define("ui/component/Comment", ["require", "exports", "endpoint/comment/EndpointCommentAdd", "endpoint/comment/EndpointCommentRemove", "endpoint/comment/EndpointCommentUpdate", "endpoint/reaction/EndpointReactComment", "endpoint/reaction/EndpointUnreactComment", "lang/en-nz", "model/FormInputLengths", "model/Session", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/Button", "ui/component/core/Link", "ui/component/core/Slot", "ui/component/core/TextEditor", "ui/component/core/Timestamp"], function (require, exports, EndpointCommentAdd_1, EndpointCommentRemove_1, EndpointCommentUpdate_1, EndpointReactComment_1, EndpointUnreactComment_1, en_nz_8, FormInputLengths_4, Session_10, Component_46, ActionRow_5, Button_12, Link_4, Slot_10, TextEditor_3, Timestamp_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    EndpointCommentAdd_1 = __importDefault(EndpointCommentAdd_1);
    EndpointCommentRemove_1 = __importDefault(EndpointCommentRemove_1);
    ...
    const Comment = Component_46.default.Builder((component, source, commentData, meta) => {
        const comment = component.and(Slot_10.default)
            .style('comment')
            .extend(comment => ({}));
        ...
        comment.use(comments, (slot, commentsData) => {
            ...
            if (commentData && !meta?.isRootComment) {
                ...
                (0, Link_4.default)(!author?.vanity ? undefined : `/author/${author.vanity}`)
                    .style('comment-header-author')
                    .text.set(author?.name ?? en_nz_8.default['comment/deleted/author']().toString())
                    .appendTo(header);
                const time = commentData.edited_time ?? commentData.created_time;
                if (time)
                    (0, Timestamp_2.default)(time)
                        .style('comment-header-timestamp')
                        .setTranslation(!commentData.edited_time ? undefined : en_nz_8.default['comment/timestamp/edited'])
                        .appendTo(header);
                if (commentData.edit) {
                    ////////////////////////////////////
                    ...
                    const textEditor = (0, TextEditor_3.default)()
                        ...
                        .setMaxLength(FormInputLengths_4.default.manifest?.comment.body)
                        .hint.use('comment/hint')
                        .appendTo(content);
                    textEditor.content.use(header, markdown => commentData.body = { body: markdown });
                    const footer = (0, Component_46.default)('footer').and(ActionRow_5.default)
                    ...
                    if (commentData.comment_id)
                        (0, Button_12.default)()
                            ...
                            .event.subscribe('click', async () => {
                            const response = await EndpointCommentRemove_1.default.query({ params: { id: commentData.comment_id } });
                            if (response instanceof Error)
                                return;
                    ...
                    (0, Component_46.default)()
                        .style('comment-body')
                        .setMarkdownContent(commentData.body?.body ?? en_nz_8.default['comment/deleted/body']().toString())
                        .appendTo(content);
                    (0, Slot_10.default)()
                        .use(Session_10.default.Auth.author, (slot, author) => {
                        if (!author)
                            return;
                        const footer = (0, Component_46.default)('footer')
                            .style('comment-footer')
                            .appendTo(content);
                        (0, Component_46.default)()
                            .style('comment-footer-reaction')
                            .append((0, Button_12.default)()
                            ...
                            comments.emit();
                        }), commentData.reactions && (0, Component_46.default)()
            ...
            const childrenWrapper = (0, Component_46.default)()
...
define("ui/component/Comments", ["require", "exports", "endpoint/comment/EndpointCommentGetAllUnder", "model/Session", "ui/Component", "ui/component/Comment", "ui/component/core/Block", "ui/component/core/Button", "ui/component/core/Slot", "utility/AbortPromise", "utility/State"], function (require, exports, EndpointCommentGetAllUnder_1, Session_11, Component_47, Comment_1, Block_10, Button_13, Slot_11, AbortPromise_3, State_31) {
    ...
    const Comments = Component_47.default.Builder((rawComponent, under, isRootComment) => {
        const component = rawComponent
            .classes.add(Block_10.BlockClasses.Main)
            .style('comment-list')
            .extend(component => ({}));
        (0, Slot_11.default)()
            .use(Session_11.default.Auth.author, AbortPromise_3.default.asyncFunction(async (signal, slot, author) => {
            const comment = { comment_id: under };
            const comments = (0, State_31.default)([comment]);
            const authors = (0, State_31.default)(!author ? [] : [author]);
            if (author)
            ...
            const query = (0, State_31.default)(undefined);
            query.value = EndpointCommentGetAllUnder_1.default.prep({ params: { under } }).query;
            (0, Comment_1.default)({ comments, authors }, comment, { isRootComment: true, noSiblings: true })
                .appendTo(component);
            await loadMore();
            if (signal.aborted)
                return;
            (0, Slot_11.default)()
                .if(query.truthy, () => (0, Button_13.default)()
...
define("ui/view/shared/component/PaginatedView", ["require", "exports", "ui/Component", "ui/component/core/Paginator", "ui/view/shared/component/View"], function (require, exports, Component_48, Paginator_2, View_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_48 = __importDefault(Component_48);
    Paginator_2 = __importDefault(Paginator_2);
    View_5 = __importDefault(View_5);
    const PaginatedView = Component_48.default.Builder((_, id) => {
        let paginator;
        const urls = [];
...
define("ui/view/ChapterView", ["require", "exports", "endpoint/chapter/EndpointChapterGet", "endpoint/chapter/EndpointChapterGetPaged", "endpoint/work/EndpointWorkGet", "lang/en-nz", "ui/component/Comments", "ui/component/core/Link", "ui/component/core/Slot", "ui/component/Work", "ui/view/shared/component/PaginatedView", "ui/view/shared/component/ViewDefinition", "utility/maths/Maths", "utility/State"], function (require, exports, EndpointChapterGet_2, EndpointChapterGetPaged_1, EndpointWorkGet_1, en_nz_9, Comments_1, Link_5, Slot_12, Work_2, PaginatedView_1, ViewDefinition_4, Maths_2, State_32) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = (0, ViewDefinition_4.default)({
        create: async (params) => {
            ...
            (0, Link_5.default)(`/work/${author?.vanity}/${workData.vanity}`)
            ...
            const chapterState = (0, State_32.default)(initialChapterResponse.data);
            ...
            const paginator = await view.paginator()
                ...
                .type('flush')
                .tweak(p => p.title.text.bind(chapterState.mapManual(chapter => en_nz_9.default['view/chapter/title'](Maths_2.default.parseIntOrUndefined(chapter.url), chapter.name))))
                .appendTo(view)
...
define("ui/view/debug/ButtonRegistry", ["require", "exports", "model/Session", "utility/Env"], function (require, exports, Session_12, Env_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.BUTTON_REGISTRY = {
        createAuthor: {
            ...
            async execute(name, vanity, description, pronouns) {
                ...
                await Session_12.default.refresh();
            },
        },
        updateAuthor: {
            name: 'Update Author',
            ...
            for (const service of Objects_4.default.values(OAuthServices.data ?? {})) {
                ...
                (0, Button_14.default)()
                    ...
                    await (0, Popup_2.default)(`OAuth ${service.name}`, service.url_begin, 600, 900)
                        .then(() => true).catch(err => { console.warn(err); return false; });
                    await Session_13.default.refresh();
                })
                    .appendTo(oauthDiv);
                (0, Button_14.default)()
                    .text.set(`UnOAuth ${service.name}`)
                    .event.subscribe('click', async () => {
                    const id = Session_13.default.Auth.get(service.id)?.id;
                    if (id === undefined)
                        return;
...
define("endpoint/feed/EndpointFeedGet", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_23) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_23 = __importDefault(Endpoint_23);
    exports.default = (0, Endpoint_23.default)('/feed/get', 'get');
});
define("ui/view/FeedView", ["require", "exports", "endpoint/feed/EndpointFeedGet", "ui/Component", "ui/component/core/Link", "ui/component/core/Paginator", "ui/component/Work", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition"], function (require, exports, EndpointFeedGet_1, Component_50, Link_6, Paginator_3, Work_3, View_7, ViewDefinition_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        create: async () => {
            ...
            await paginator.useEndpoint(endpoint, (slot, { works, authors }) => {
                for (const workData of works) {
                    ...
                    (0, Link_6.default)(author && `/work/${author.vanity}/${workData.vanity}`)
                        .and(Work_3.default, workData, author, true)
                        .viewTransition()
                        .appendTo(slot);
                }
            });
            paginator.orElse(slot => (0, Component_50.default)()
                .style('placeholder')
...
define("ui/view/HomeView", ["require", "exports", "markdown-it", "ui/Component", "ui/component/core/Block", "ui/component/core/TextEditor", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "utility/Env", "utility/string/MarkdownItHTML"], function (require, exports, markdown_it_2, Component_51, Block_11, TextEditor_4, View_8, ViewDefinition_7, Env_7, MarkdownItHTML_2) {
    ...
    exports.default = (0, ViewDefinition_7.default)({
        create: () => {
            ...
            const block = (0, Block_11.default)().appendTo(view);
            ...
            if (Env_7.default.isDev) {
                (0, Component_51.default)('br').appendTo(block.content);
                const output = (0, Component_51.default)('div');
                (0, Component_51.default)('div')
...
define("endpoint/work/EndpointWorkDelete", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_24) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_24 = __importDefault(Endpoint_24);
    exports.default = (0, Endpoint_24.default)('/work/{author}/{vanity}/delete', 'post');
});
define("endpoint/work/EndpointWorkCreate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_25) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_25 = __importDefault(Endpoint_25);
    exports.default = (0, Endpoint_25.default)('/work/create', 'post');
});
define("endpoint/work/EndpointWorkUpdate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_26) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_26 = __importDefault(Endpoint_26);
    exports.default = (0, Endpoint_26.default)('/work/{author}/{vanity}/update', 'post');
});
define("ui/component/core/Textarea", ["require", "exports", "lang/en-nz", "ui/Component", "ui/component/core/ext/Input", "ui/utility/StringApplicator", "utility/State"], function (require, exports, en_nz_10, Component_52, Input_4, StringApplicator_7, State_33) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Textarea = Component_52.default.Builder((component) => {
        let shouldIgnoreInputEvent = false;
        const contenteditable = (0, Component_52.default)()
            .style('text-input', 'text-area')
            .attributes.set('contenteditable', 'plaintext-only')
            .ariaRole('textbox')
            .attributes.set('aria-multiline', 'true');
        const hiddenInput = (0, Component_52.default)('input')
        ...
        input.onRooted(input => {
            contenteditable.event.subscribe(['input', 'change'], event => {
                ...
                let invalid;
                if (input.length.value > (input.maxLength.value ?? Infinity))
                    invalid = en_nz_10.default['shared/form/invalid/too-long']();
                input.setCustomInvalidMessage(invalid);
            });
        });
        return input;
...
define("ui/component/core/ext/Sortable", ["require", "exports", "ui/Component", "ui/component/core/ext/Draggable", "utility/Arrays", "utility/maths/Vector2", "utility/State"], function (require, exports, Component_53, Draggable_2, Arrays_6, Vector2_2, State_34) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const isSortingAnySortable = (0, State_34.default)(false);
    exports.default = Object.assign(Component_53.default.Extension((component, definition) => {
        const sorting = (0, State_34.default)(false);
        const sortDelay = (0, State_34.default)(definition.sortDelay ?? 0);
        const stickyDistance = (0, State_34.default)(definition.stickyDistance ?? 0);
        const order = (0, State_34.default)([]);
        ...
        function getDraggables() {
            return [...component.getChildren()]
                ...
                .filter(Arrays_6.default.filterNullish);
        }
...
define("ui/utility/Applicator", ["require", "exports", "utility/State"], function (require, exports, State_35) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function Applicator(host, defaultValueOrApply, apply) {
        ...
        function makeApplicator(host) {
            return {
                state: (0, State_35.default)(defaultValue),
                set: value => {
                    unbind?.();
                    setInternal(value);
                    return host;
...
define("ui/component/TagsEditor", ["require", "exports", "lang/en-nz", "model/Tags", "ui/Component", "ui/component/core/Block", "ui/component/core/ext/Input", "ui/component/core/ext/Sortable", "ui/component/core/ProgressWheel", "ui/component/core/Slot", "ui/component/core/TextInput", "ui/component/Tag", "ui/utility/AnchorManipulator", "ui/utility/Applicator", "utility/AbortPromise", "utility/Mouse", "utility/State", "utility/string/Strings"], function (require, exports, en_nz_11, Tags_3, Component_54, Block_12, Input_5, Sortable_1, ProgressWheel_2, Slot_13, TextInput_5, Tag_2, AnchorManipulator_3, Applicator_1, AbortPromise_4, Mouse_4, State_36, Strings_3) {
    ...
    TextInput_5 = __importStar(TextInput_5);
    ...
    const TagsEditor = Component_54.default.Builder((component) => {
        const tagsState = (0, State_36.default)({ global_tags: [], custom_tags: [] });
        ////////////////////////////////////
        //#region Current
        const tagsContainer = (0, Slot_13.default)()
            .style('tags-editor-current')
            .use(tagsState, AbortPromise_4.default.asyncFunction(async (signal, slot, tags) => {
            const globalTags = await Tags_3.default.resolve(tags.global_tags);
            if (signal.aborted)
                return;
            if (globalTags.length)
                (0, Component_54.default)()
                    .and(Sortable_1.default, (0, Sortable_1.SortableDefinition)({
                    getID: component => getTagID(component.as(Tag_2.default)?.tag),
                    onOrderChange: order => {
        ...
        //#endregion
        ////////////////////////////////////
        const inputWrapper = (0, Component_54.default)()
        ...
        ////////////////////////////////////
        //#region Suggestions
        const hasOrHadFocus = State_36.default.Some(component, component.hasFocused, component.hadFocusedLast);
        const suggestions = (0, Slot_13.default)()
            .style('tags-editor-suggestions')
            .use(State_36.default.UseManual({
            tags: tagsState,
            filter: input.state,
            focus: hasOrHadFocus,
        }), AbortPromise_4.default.asyncFunction(async (signal, slot, { tags, filter, focus }) => {
            if (!filter && !focus)
                return;
            const manifest = await Tags_3.default.getManifest();
            if (signal.aborted)
                return;
            let [category, name] = Strings_3.default.splitOnce(filter, ':');
            if (name === undefined)
            ...
            const categorySuggestions = category ? []
                : Object.values(manifest.categories)
                    ...
                    .map(category => Tag_2.default.Category(category)
            ...
            const customTagSuggestions = select(() => {
                if (!name)
                    return [];
                if (!category)
                    return [(0, Tag_2.default)(name)];
                return [(0, Tag_2.default)(`${name} ${category}`), (0, Tag_2.default)(`${category} ${name}`)];
            });
        ...
        //#endregion
        ////////////////////////////////////
        const hiddenInput = (0, Component_54.default)('input')
        ...
        const editor = component
            ...
            maxLengthGlobal: (0, State_36.default)(undefined),
            maxLengthCustom: (0, State_36.default)(undefined),
        ...
        editor.setCustomHintPopover(popover => popover
            .append(Input_5.default.createHintText(en_nz_11.default['shared/form/tags/hint/main']()), Input_5.default.createHintText(en_nz_11.default['shared/form/tags/hint/global']()), ProgressWheel_2.default.Length(editor.lengthGlobal, editor.maxLengthGlobal), Input_5.default.createHintText(en_nz_11.default['shared/form/tags/hint/custom']()), ProgressWheel_2.default.Length(editor.lengthCustom, editor.maxLengthCustom))
            .anchor.reset()
            .anchor.from(input)
            .anchor.add('off right', `.\\${Block_12.BlockClasses.Main}`, 'centre', AnchorManipulator_3.AllowYOffscreen));
        tagsState.use(editor, tags => {
            let invalid;
            if (tags.global_tags.length > (editor.maxLengthGlobal.value ?? Infinity))
                invalid = en_nz_11.default['shared/form/invalid/tags/too-many-global']();
            else if (tags.custom_tags.length > (editor.maxLengthCustom.value ?? Infinity))
                invalid = en_nz_11.default['shared/form/invalid/tags/too-many-custom']();
            editor.setCustomInvalidMessage(invalid);
        });
        input.event.subscribe('keydown', event => {
            if (event.key === 'Enter') {
                event.preventDefault();
                suggestions.getFirstDescendant(Tag_2.default)?.element.click();
            }
        });
        return editor;
    ...
    ////////////////////////////////////
    //#region Input Filter
    const TagsFilter = (0, TextInput_5.FilterFunction)((before, selected, after) => {
...
define("ui/view/work/WorkEditForm", ["require", "exports", "endpoint/work/EndpointWorkCreate", "endpoint/work/EndpointWorkUpdate", "lang/en-nz", "model/FormInputLengths", "model/Session", "ui/Component", "ui/component/core/Block", "ui/component/core/Form", "ui/component/core/LabelledTable", "ui/component/core/Textarea", "ui/component/core/TextEditor", "ui/component/core/TextInput", "ui/component/core/toast/Toast", "ui/component/TagsEditor", "ui/component/VanityInput"], function (require, exports, EndpointWorkCreate_1, EndpointWorkUpdate_1, en_nz_12, FormInputLengths_5, Session_14, Component_55, Block_13, Form_4, LabelledTable_3, Textarea_1, TextEditor_5, TextInput_6, Toast_3, TagsEditor_1, VanityInput_2) {
    ...
    exports.default = Component_55.default.Builder((component, state) => {
        const block = component.and(Block_13.default);
        ...
        form.setName(en_nz_12.default[`view/work-edit/${type}/title`]().toString());
        // if (params.type === "create")
        // 	form.description.text.use("view/work-edit/create/description")
        ...
        const nameInput = (0, TextInput_6.default)()
            ...
            .setMaxLength(FormInputLengths_5.default.manifest?.work.name);
        ...
        const vanityInput = (0, TextInput_6.default)()
            ...
            .setMaxLength(FormInputLengths_5.default.manifest?.work.vanity);
        ...
        const descriptionInput = (0, Textarea_1.default)()
            ...
            .setMaxLength(FormInputLengths_5.default.manifest?.work.description);
        ...
        const synopsisInput = (0, TextEditor_5.default)()
            ...
            .setMaxLength(FormInputLengths_5.default.manifest?.work.synopsis);
        ...
        const tagsEditor = (0, TagsEditor_1.default)()
            .default.bind(state)
            .setMaxLengthGlobal(FormInputLengths_5.default.manifest?.work_tags.global)
            .setMaxLengthCustom(FormInputLengths_5.default.manifest?.work_tags.custom);
            ...
            const response = await (() => {
                switch (type) {
                    ...
                    case 'update': {
                        if (!state.value)
                            return;
                        const authorVanity = Session_14.default.Auth.author.value?.vanity;
                        if (!authorVanity)
                            return new Error('Cannot update a work when not signed in');
...
define("ui/view/WorkEditView", ["require", "exports", "endpoint/work/EndpointWorkDelete", "endpoint/work/EndpointWorkGet", "ui/component/core/ActionRow", "ui/component/core/Button", "ui/component/core/ConfirmDialog", "ui/component/core/Slot", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition", "ui/view/shared/ext/ViewTransition", "ui/view/work/WorkEditForm", "utility/State"], function (require, exports, EndpointWorkDelete_1, EndpointWorkGet_2, ActionRow_6, Button_15, ConfirmDialog_2, Slot_14, View_10, ViewDefinition_9, ViewTransition_4, WorkEditForm_1, State_37) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = (0, ViewDefinition_9.default)({
        ...
        create: async (params) => {
            ...
            if (work instanceof Error)
                throw work;
            const state = (0, State_37.default)(work?.data);
            const stateInternal = (0, State_37.default)(work?.data);
            (0, Slot_14.default)()
            ...
            function createActionRow() {
                ...
                return (0, ActionRow_6.default)()
                    ...
                    .tweak(row => row.right
                    .append((0, Button_15.default)()
                    .text.use('view/work-edit/update/action/delete')
                    .event.subscribe('click', async () => {
                    if (!params)
                        return;
                    const result = await ConfirmDialog_2.default.prompt(view, { dangerToken: 'delete-work' });
                    if (!result)
                        return;
                    const response = await EndpointWorkDelete_1.default.query({ params });
                    if (response instanceof Error) {
                        console.error(response);
                        return;
                    }
...
define("endpoint/chapter/EndpointChapterGetAll", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_27) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_27 = __importDefault(Endpoint_27);
    exports.default = (0, Endpoint_27.default)('/work/{author}/{vanity}/chapters/list', 'get');
});
define("ui/component/Chapter", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/ext/CanHasActionsMenuButton", "ui/component/core/Link", "ui/component/core/Timestamp", "utility/maths/Maths"], function (require, exports, Session_15, Component_56, Button_16, CanHasActionsMenuButton_2, Link_7, Timestamp_3, Maths_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Chapter = Component_56.default.Builder((component, chapter, work, author) => {
        component = (0, Link_7.default)(`/work/${author.vanity}/${work.vanity}/chapter/${chapter.url}`)
            .style('chapter');
        const chapterNumber = Maths_3.default.parseIntOrUndefined(chapter.url);
        const number = (0, Component_56.default)()
            .style('chapter-number')
            .text.set(chapterNumber ? `${chapterNumber.toLocaleString()}` : '')
            .appendTo(component);
        const chapterName = (0, Component_56.default)()
            .style('chapter-name')
            .text.set(chapter.name)
            .appendTo(component);
        const right = (0, Component_56.default)()
            .style('chapter-right')
            .appendTo(component);
        const timestamp = !chapter.time_last_update ? undefined
            : (0, Timestamp_3.default)(chapter.time_last_update)
        ...
        return component
            ...
            if (author && author.vanity === Session_15.default.Auth.author.value?.vanity) {
                (0, Button_16.default)()
                    .type('flush')
    ...
    exports.default = (0, ViewDefinition_10.default)({
        create: async (params) => {
            ...
            const paginator = (0, Paginator_4.default)()
                ...
                .tweak(p => p.primaryActions.append((0, Slot_15.default)()
                .if(Session_16.default.Auth.loggedIn, () => (0, Button_17.default)()
                .setIcon('plus')
            ...
            paginator.orElse(slot => (0, Component_57.default)()
                .style('placeholder')
...
define("ui/view/ErrorView", ["require", "exports", "lang/en-nz", "ui/component/core/Heading", "ui/component/core/Paragraph", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition"], function (require, exports, en_nz_13, Heading_2, Paragraph_3, View_12, ViewDefinition_11) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ui/view/RequireLoginView", ["require", "exports", "ui/component/core/ActionRow", "ui/component/core/Block", "ui/component/core/Button", "ui/view/AccountView", "ui/view/shared/component/View", "ui/view/shared/component/ViewDefinition"], function (require, exports, ActionRow_7, Block_14, Button_18, AccountView_2, View_13, ViewDefinition_12) {
    ...
    exports.default = (0, ViewDefinition_12.default)({
        create: () => {
            ...
            const block = (0, Block_14.default)().appendTo(view);
...
define("ui/view/shared/component/ViewContainer", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/Dialog", "ui/view/AccountView", "ui/view/ErrorView", "ui/view/RequireLoginView", "ui/view/shared/ext/ViewTransition"], function (require, exports, Session_17, Component_58, Button_19, Dialog_3, AccountView_3, ErrorView_1, RequireLoginView_1, ViewTransition_5) {
    ...
    const ViewContainer = () => {
        let cancelLogin;
        const container = (0, Component_58.default)()
            ...
            show: async (definition, params) => {
                ...
                const needsLogin = definition.requiresLogin && !Session_17.default.Auth.loggedIn.value;
                if (needsLogin || definition.load) {
                    ...
                    await loginPromise;
                    if (needsLogin && !Session_17.default.Auth.loggedIn.value) {
                        let setLoggedIn;
                        ...
                        ViewTransition_5.default.perform('view', async () => {
                            ...
                            if (!view)
                                return;
                            Session_17.default.Auth.loggedIn.subscribe(view, loggedIn => loggedIn && setLoggedIn());
                        });
                        await loggedIn;
                    }
                }
        ...
        function logIn() {
            if (Session_17.default.Auth.author.value)
                return;
            ...
            const authPromise = accountViewShown.then(async (view) => {
                ...
                await Promise.race([
                    Session_17.default.Auth.await(view),
                    loginCancelledPromise,
                ]);
                cancelLogin = undefined;
                return Session_17.default.Auth.loggedIn.value;
            });
            return {
                accountViewShown,
                authed: authPromise,
...
define("ui/component/masthead/Flag", ["require", "exports", "ui/Component", "utility/Arrays"], function (require, exports, Component_59, Arrays_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_59 = __importDefault(Component_59);
    Arrays_7 = __importDefault(Arrays_7);
    const Flag = Component_59.default.Builder((component) => {
        const stripes = Arrays_7.default.range(5)
            .map(i => (0, Component_59.default)()
...
define("ui/component/PrimaryNav", ["require", "exports", "ui/Component"], function (require, exports, Component_60) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_60 = __importDefault(Component_60);
    exports.default = Component_60.default.Builder(nav => {
        // Heading()
        // 	.text.set("hi")
        // 	.appendTo(nav)
        return nav;
...
define("ui/component/Sidebar", ["require", "exports", "ui/Component", "ui/component/core/Button", "ui/component/core/Link", "utility/Env", "utility/Store"], function (require, exports, Component_61, Button_20, Link_8, Env_10, Store_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Sidebar = Component_61.default.Builder('nav', (sidebar) => {
        sidebar.style('sidebar')
            .ariaLabel.use('masthead/primary-nav/alt');
        if (Env_10.default.ENVIRONMENT === 'dev')
            (0, Link_8.default)('/debug')
                .and(Button_20.default)
                .text.set('Debug')
                .appendTo(sidebar);
...
define("ui/component/Masthead", ["require", "exports", "model/Session", "ui/Component", "ui/component/core/Button", "ui/component/core/Link", "ui/component/core/Slot", "ui/component/masthead/Flag", "ui/component/PrimaryNav", "ui/component/Sidebar", "ui/utility/Viewport", "utility/Env", "utility/Task"], function (require, exports, Session_18, Component_62, Button_21, Link_9, Slot_16, Flag_1, PrimaryNav_1, Sidebar_1, Viewport_4, Env_11, Task_4) {
    ...
    const Masthead = Component_62.default.Builder('header', (masthead, view) => {
        ...
        (0, Button_21.default)()
            ...
            .appendTo(masthead);
        let popover;
        const left = (0, Component_62.default)()
            .append((0, Component_62.default)()
        ...
        const homeLink = (0, Link_9.default)('/')
            ...
            .append(flag)
            .append((0, Component_62.default)('img')
        ...
        (0, Component_62.default)()
            ...
            .ariaRole('navigation')
            .append((0, Slot_16.default)()
            .use(Session_18.default.Auth.author, (slot, author) => {
            if (!author) {
                (0, Link_9.default)('/account')
                    .and(Button_21.default)
                    .type('flush')
            ...
            (0, Link_9.default)(`/author/${author.vanity}`)
                .and(Button_21.default)
                .type('flush')
...
define("App", ["require", "exports", "lang/en-nz", "model/FormInputLengths", "model/Session", "navigation/Navigate", "style", "ui/Component", "ui/component/core/toast/ToastList", "ui/component/Masthead", "ui/InputBus", "ui/utility/ActiveListener", "ui/utility/FocusListener", "ui/utility/HoverListener", "ui/utility/Mouse", "ui/utility/Viewport", "ui/view/shared/component/ViewContainer", "utility/Async", "utility/Store", "utility/Time"], function (require, exports, en_nz_14, FormInputLengths_6, Session_19, Navigate_1, style_2, Component_63, ToastList_1, Masthead_1, InputBus_2, ActiveListener_1, FocusListener_3, HoverListener_2, Mouse_5, Viewport_5, ViewContainer_1, Async_5, Store_5, Time_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    async function App() {
        ...
        await Promise.race([
            Session_19.default.refresh(),
            Async_5.default.sleep(Time_8.default.seconds(2)),
        ]);
        ...
        document.title = en_nz_14.default['fluff4me/title']().toString();
        ...
        const related = (0, Component_63.default)()
            .style('app-content-related');
        const content = (0, Component_63.default)()
            .style('app-content')
            .monitorScrollEvents()
            .append(view, related);
        const app = (0, Component_63.default)()
            .style('app')
...
define("index", ["require", "exports", "utility/Arrays", "utility/DOMRect", "utility/Elements", "browser-source-map-support", "utility/Env"], function (require, exports, Arrays_8, DOMRect_1, Elements_1, browser_source_map_support_1, Env_12) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Arrays_8 = __importDefault(Arrays_8);
    ...
    (0, DOMRect_1.default)();
    Arrays_8.default.applyPrototypes();
...
define("endpoint/chapter/EndpointChapterDelete", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_28) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_28 = __importDefault(Endpoint_28);
    exports.default = (0, Endpoint_28.default)('/work/{author}/{vanity}/chapter/{url}/delete', 'post');
});
define("endpoint/feed/EndpointFeedGetAuthed", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_29) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_29 = __importDefault(Endpoint_29);
    exports.default = (0, Endpoint_29.default)('/feed/get/authed', 'get');
});
define("endpoint/feed/EndpointFeedGetFollowed", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_30) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_30 = __importDefault(Endpoint_30);
    exports.default = (0, Endpoint_30.default)('/feed/get/followed', 'get');
});
define("endpoint/follow/EndpointFollowAdd", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_31) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_31 = __importDefault(Endpoint_31);
    exports.default = (0, Endpoint_31.default)('/follow/{type}/{vanity}', 'post');
});
define("endpoint/follow/EndpointFollowAddWork", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_32) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_32 = __importDefault(Endpoint_32);
    exports.default = (0, Endpoint_32.default)('/follow/work/{author}/{vanity}', 'post');
});
define("endpoint/follow/EndpointFollowGet", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_33) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_33 = __importDefault(Endpoint_33);
    exports.default = (0, Endpoint_33.default)('/follows/{type}/{vanity}', 'get');
});
define("endpoint/follow/EndpointFollowGetAll", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_34) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_34 = __importDefault(Endpoint_34);
    exports.default = (0, Endpoint_34.default)('/following/{type}', 'get');
});
define("endpoint/follow/EndpointFollowGetAllMerged", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_35) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_35 = __importDefault(Endpoint_35);
    exports.default = (0, Endpoint_35.default)('/following', 'get');
});
define("endpoint/follow/EndpointFollowGetWork", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_36) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_36 = __importDefault(Endpoint_36);
    exports.default = (0, Endpoint_36.default)('/follows/work/{author}/{vanity}', 'get');
});
define("endpoint/follow/EndpointFollowRemove", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_37) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_37 = __importDefault(Endpoint_37);
    exports.default = (0, Endpoint_37.default)('/unfollow/{type}/{vanity}', 'post');
});
define("endpoint/follow/EndpointFollowRemoveWork", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_38) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_38 = __importDefault(Endpoint_38);
    exports.default = (0, Endpoint_38.default)('/unfollow/work/{author}/{vanity}', 'post');
});
define("endpoint/ignore/EndpointIgnoreAdd", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_39) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_39 = __importDefault(Endpoint_39);
    exports.default = (0, Endpoint_39.default)('/ignore/{type}/{vanity}', 'post');
});
define("endpoint/ignore/EndpointIgnoreAddWork", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_40) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_40 = __importDefault(Endpoint_40);
    exports.default = (0, Endpoint_40.default)('/ignore/work/{author}/{vanity}', 'post');
});
define("endpoint/ignore/EndpointIgnoreGet", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_41) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_41 = __importDefault(Endpoint_41);
    exports.default = (0, Endpoint_41.default)('/ignores/{type}/{vanity}', 'get');
});
define("endpoint/ignore/EndpointIgnoreGetAll", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_42) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_42 = __importDefault(Endpoint_42);
    exports.default = (0, Endpoint_42.default)('/ignoring/{type}', 'get');
});
define("endpoint/ignore/EndpointIgnoreGetAllMerged", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_43) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_43 = __importDefault(Endpoint_43);
    exports.default = (0, Endpoint_43.default)('/ignoring', 'get');
});
define("endpoint/ignore/EndpointIgnoreGetWork", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_44) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_44 = __importDefault(Endpoint_44);
    exports.default = (0, Endpoint_44.default)('/ignores/work/{author}/{vanity}', 'get');
});
define("endpoint/ignore/EndpointIgnoreRemove", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_45) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_45 = __importDefault(Endpoint_45);
    exports.default = (0, Endpoint_45.default)('/unignore/{type}/{vanity}', 'post');
});
define("endpoint/ignore/EndpointIgnoreRemoveWork", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_46) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_46 = __importDefault(Endpoint_46);
    exports.default = (0, Endpoint_46.default)('/unignore/work/{author}/{vanity}', 'post');
});
define("endpoint/notification/EndpointNotificationGet", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_47) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_47 = __importDefault(Endpoint_47);
    exports.default = (0, Endpoint_47.default)('/notifications/get/all', 'get');
});
define("endpoint/notification/EndpointNotificationGetCount", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_48) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_48 = __importDefault(Endpoint_48);
    exports.default = (0, Endpoint_48.default)('/notifications/get/count', 'get');
});
define("endpoint/notification/EndpointNotificationGetUnread", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_49) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_49 = __importDefault(Endpoint_49);
    exports.default = (0, Endpoint_49.default)('/notifications/get/unread', 'get');
});
define("endpoint/notification/EndpointNotificationMarkRead", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_50) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_50 = __importDefault(Endpoint_50);
    exports.default = (0, Endpoint_50.default)('/notifications/mark/read', 'post');
});
define("endpoint/notification/EndpointNotificationMarkUnread", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_51) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_51 = __importDefault(Endpoint_51);
    exports.default = (0, Endpoint_51.default)('/notifications/mark/unread', 'post');
});
define("endpoint/patreon/EndpointPatreonGetTiers", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_52) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_52 = __importDefault(Endpoint_52);
    exports.default = (0, Endpoint_52.default)('/patreon/campaign/tiers/get', 'get');
});
define("endpoint/patreon/EndpointPatreonSetThresholds", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_53) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_53 = __importDefault(Endpoint_53);
    exports.default = (0, Endpoint_53.default)('/patreon/campaign/tiers/set/{author}/{vanity}', 'post');
});
define("endpoint/privilege/EndpointPrivilegeGetAllAuthor", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_54) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_54 = __importDefault(Endpoint_54);
    exports.default = (0, Endpoint_54.default)('/privilege/get/{vanity}', 'get');
});
define("endpoint/privilege/EndpointPrivilegeGrantAuthor", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_55) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_55 = __importDefault(Endpoint_55);
    exports.default = (0, Endpoint_55.default)('/privilege/grant/author/{vanity}', 'post');
});
define("endpoint/privilege/EndpointPrivilegeGrantRole", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_56) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_56 = __importDefault(Endpoint_56);
    exports.default = (0, Endpoint_56.default)('/privilege/grant/role/{vanity}', 'post');
});
define("endpoint/privilege/EndpointPrivilegeRevokeAuthor", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_57) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_57 = __importDefault(Endpoint_57);
    exports.default = (0, Endpoint_57.default)('/privilege/revoke/author/{vanity}', 'post');
});
define("endpoint/privilege/EndpointPrivilegeRevokeRole", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_58) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_58 = __importDefault(Endpoint_58);
    exports.default = (0, Endpoint_58.default)('/privilege/revoke/role/{vanity}', 'post');
});
define("endpoint/reaction/EndpointReactChapter", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_59) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_59 = __importDefault(Endpoint_59);
    exports.default = (0, Endpoint_59.default)('/work/{author}/{vanity}/chapter/{url}/react/{type}', 'post');
});
define("endpoint/reaction/EndpointUnreactChapter", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_60) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_60 = __importDefault(Endpoint_60);
    exports.default = (0, Endpoint_60.default)('/work/{author}/{vanity}/chapter/{url}/unreact', 'post');
});
define("endpoint/role/EndpointRoleCreate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_61) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_61 = __importDefault(Endpoint_61);
    exports.default = (0, Endpoint_61.default)('/role/create', 'post');
});
define("endpoint/role/EndpointRoleDelete", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_62) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_62 = __importDefault(Endpoint_62);
    exports.default = (0, Endpoint_62.default)('/role/delete/{role}', 'post');
});
define("endpoint/role/EndpointRoleGrantAuthor", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_63) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_63 = __importDefault(Endpoint_63);
    exports.default = (0, Endpoint_63.default)('/role/grant/{role}/{author}', 'post');
});
define("endpoint/role/EndpointRoleListAll", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_64) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_64 = __importDefault(Endpoint_64);
    exports.default = (0, Endpoint_64.default)('/role/get', 'get');
});
define("endpoint/role/EndpointRoleReorder", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_65) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_65 = __importDefault(Endpoint_65);
    exports.default = (0, Endpoint_65.default)('/role/reorder', 'post');
});
define("endpoint/role/EndpointRoleRevokeAuthor", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_66) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_66 = __importDefault(Endpoint_66);
    exports.default = (0, Endpoint_66.default)('/role/revoke/{role}/{author}', 'post');
});
define("endpoint/role/EndpointRoleUpdate", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_67) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_67 = __importDefault(Endpoint_67);
    exports.default = (0, Endpoint_67.default)('/role/update/{role}', 'post');
});
define("endpoint/tag/EndpointTagCreateCategory", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_68) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_68 = __importDefault(Endpoint_68);
    exports.default = (0, Endpoint_68.default)('/tag/create/category', 'post');
});
define("endpoint/tag/EndpointTagCreateGlobal", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_69) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_69 = __importDefault(Endpoint_69);
    exports.default = (0, Endpoint_69.default)('/tag/create/global', 'post');
});
define("endpoint/tag/EndpointTagCustomPromote", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_70) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_70 = __importDefault(Endpoint_70);
    exports.default = (0, Endpoint_70.default)('/tag/promote/{vanity}', 'post');
});
define("endpoint/tag/EndpointTagGlobalDemote", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_71) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_71 = __importDefault(Endpoint_71);
    exports.default = (0, Endpoint_71.default)('/tag/demote/{vanity}', 'post');
});
define("endpoint/tag/EndpointTagRemoveCategory", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_72) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_72 = __importDefault(Endpoint_72);
    exports.default = (0, Endpoint_72.default)('/tag/remove/category/{vanity}', 'post');
});
define("endpoint/tag/EndpointTagRemoveGlobal", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_73) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_73 = __importDefault(Endpoint_73);
    exports.default = (0, Endpoint_73.default)('/tag/remove/global/{vanity}', 'post');
});
define("endpoint/tag/EndpointTagUpdateCategory", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_74) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_74 = __importDefault(Endpoint_74);
    exports.default = (0, Endpoint_74.default)('/tag/update/category/{vanity}', 'post');
});
define("endpoint/tag/EndpointTagUpdateGlobal", ["require", "exports", "endpoint/Endpoint"], function (require, exports, Endpoint_75) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Endpoint_75 = __importDefault(Endpoint_75);
    exports.default = (0, Endpoint_75.default)('/tag/update/global/{vanity}', 'post');
});
define("ui/component/core/ActionHeading", ["require", "exports", "ui/Component", "ui/component/core/ActionRow", "ui/component/core/Heading"], function (require, exports, Component_64, ActionRow_8, Heading_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Component_64 = __importDefault(Component_64);
    ActionRow_8 = __importDefault(ActionRow_8);
    Heading_3 = __importDefault(Heading_3);
    const ActionHeading = Component_64.default.Builder((component) => {
...
define("utility/Tuples", ["require", "exports", "utility/Arrays"], function (require, exports, Arrays_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Tuples) {
        ...
        Tuples.make = make;
        const nullishFilters = Object.fromEntries(Arrays_9.default.range(6)
        ...
        const falsyFilters = Object.fromEntries(Arrays_9.default.range(6)
            // eslint-disable-next-line @typescript-eslint/no-unsafe-return
