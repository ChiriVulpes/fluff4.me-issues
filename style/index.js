(factory => {
	...
	exports.default = {
		...
		"block-actions-menu-button": [
			"block-actions-menu-button_2",
			"block-actions-menu-button__focus-visible-has-focus-visible",
			"block-actions-menu-button__not-focus-visible-has-focus-visible",
		],
		"block-description": [
			"column-1",
		],
		...
		"paginator-header--within-popover": [
			"relative__2",
			"top-0__2",
		],
		...
		"view-type-chapter-edit-type-example": [
			"font-1",
			"uppercase",
			"opacity-50",
			"align-self-centre",
